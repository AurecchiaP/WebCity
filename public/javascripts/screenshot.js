...
(function (a, b, c, d, e, f) {
        ...
        function n(a, c) {
            ...
            return d.width = c.width,
                d.height = c.height,
                R("Cropping canvas at:", "left:", c.left, "top:", c.top, "width:", f - e, "height:", h - g),
                R("Resulting crop with width", c.width, "and height", c.height, " with x", e, "and y", g),
                d.getContext("2d").drawImage(a, e, g, f - e, h - g, c.x, c.y, f - e, h - g),
                d
        }
        ...
        function s(a, c) {
            for (var d = 3 === a.nodeType ? b.createTextNode(a.nodeValue) : a.cloneNode(!1), e = a.firstChild; e;)
                c !== !0 && 1 === e.nodeType && "SCRIPT" === e.nodeName || d.appendChild(s(e, c)),
                    e = e.nextSibling;
            return d
        }
        ...
        function t(a, b, c, d, e, f, g) {
            ...
            return i.className = "html2canvas-container",
                ...
                new Promise(function (b) {
                        ...
                        u(a.documentElement, h, "textarea"),
                            u(a.documentElement, h, "select"),
                            i.contentWindow.onload = i.onload = function () {
                                var d = setInterval(function () {
                                    c.body.childNodes.length > 0 && (z(a, c),
                                        clearInterval(d),
                                    "view" === e.type && i.contentWindow.scrollTo(f, g),
                                        b(i))
                                }, 50)
                            }
                            ,
                            ...
                            v(a, f, g),
                            c.replaceChild(e.javascriptEnabled === !0 ? c.adoptNode(h) : A(c.adoptNode(h)), c.documentElement),
                            c.close()
                    }
                )
        }
        ...
        function u(a, b, c) {
            for (var d = a.getElementsByTagName(c), e = b.getElementsByTagName(c), f = d.length, g = 0; g < f; g++)
                e[g].value = d[g].value
        }
        ...
        function x(a) {
            return function (c) {
                ...
                try {
                    ...
                    R("DOMParser not supported, falling back to createHTMLDocument"),
                    ...
                    try {
                        ...
                        R("createHTMLDocument write not supported, falling back to document.body.innerHTML"),
                            e.body.innerHTML = c
                    }
                }
                ...
                if (!f || !f.href.host) {
                    ...
                    g.href = a,
                        e.head.insertBefore(g, e.head.firstChild)
                }
                return e
            }
        }
        ...
        function K(a, c) {
            ...
            d.style.visibility = "hidden",
                ...
                f.style.margin = 0,
                f.style.padding = 0,
                f.appendChild(b.createTextNode(g)),
                d.appendChild(f),
                d.appendChild(e),
                h = e.offsetTop - f.offsetTop + 1,
                d.removeChild(f),
                d.appendChild(b.createTextNode(g)),
                d.style.lineHeight = "normal",
                e.style.verticalAlign = "super",
                i = e.offsetTop - d.offsetTop + 1,
        ...
        function W(a) {
            var c, d, e, f, g, k, l, b = " \r\n\t", h = [], i = 0, j = 0, m = function () {
                c && ('"' === d.substr(0, 1) && (d = d.substr(1, d.length - 2)),
                d && l.push(d),
                "-" === c.substr(0, 1) && (f = c.indexOf("-", 1) + 1) > 0 && (e = c.substr(0, f),
                    c = c.substr(f)),
                    h.push({
                        prefix: e,
        ...
        function _(a, b, c, d, e) {
            R("Starting NodeParser"),
                ...
                this.support = c,
                this.renderQueue = [],
                this.stack = new Xa(!0, 1, a.ownerDocument, null);
            var f = new S(a, null);
            if (e.background && b.rectangle(0, 0, b.width, b.height, new D(e.background)),
            ...
            f.visibile = f.isElementVisible(),
                ...
                this.nodes = Ha([f].concat(this.getChildren(f)).filter(function (a) {
                ...
                this.images = d.fetch(this.nodes.filter(ya)),
                this.ready = this.images.ready.then(Da(function () {
        ...
        function Ja(b) {
            for (var f, c = [], d = 0, e = !1; b.length;)
                Ka(b[d]) === e ? (f = b.splice(0, d),
                f.length && c.push(a.html2canvas.punycode.ucs2.encode(f)),
                    e = !e,
                    d = 0) : d++,
                d >= b.length && (f = b.splice(0, d),
                f.length && c.push(a.html2canvas.punycode.ucs2.encode(f)));
            return c
        }
        ...
        function $a(a) {
            ...
            for (d = 0; d < c; d += 4)
                e = b.indexOf(a[d]),
                    ...
                    j = (15 & f) << 4 | g >> 2,
                    k = (3 & g) << 6 | h,
                    l += 64 === g ? String.fromCharCode(i) : 64 === h || h === -1 ? String.fromCharCode(i, j) : String.fromCharCode(i, j, k);
            return l
        }
        ...
        function eb(a, b) {
            ...
            this.options.canvas || (this.canvas.width = a,
                ...
                this.variables = {},
                R("Initialized CanvasRenderer with size", a, "x", b)
        }
        ...
        function jb(a) {
            return gb ? (hb = event.clientX + b.body.scrollLeft,
                ib = event.clientY + b.body.scrollTop) : (hb = a.pageX,
                ib = a.pageY),
            hb < 0 && (hb = 0),
            ib < 0 && (ib = 0),
                !0
        ...
        if (function () {
                ...
                function p(a, b) {
                    if (a === b)
                        s(a, new TypeError("You cannot resolve a promise with itself"));
                ...
                function w(a, b, c, d) {
                    ...
                    if (e) {
                        ...
                        if (g === H ? (j = !0,
                                ...
                                g = null) : i = !0,
                            b === g)
                            return void s(b, new TypeError("A promises callback cannot return that same promise."))
                    } else
                        g = d,
                            i = !0;
                ...
                function y(a, b, c, d) {
                    this.n = a,
                        ...
                        this.o(b) ? (this.m = b,
                            ...
                            this.l(),
                            0 === this.length ? r(this.c, this.b) : (this.length = this.length || 0,
                                this.k(),
                            0 === this.d && r(this.c, this.b))) : s(this.c, this.p())
                }
                ...
                y.prototype.o = function (a) {
                    ...
                    y.prototype.g = function (a, b, c) {
                        var d = this.c;
                        void 0 === d.a && (this.d--,
                            this.i && 2 === a ? s(d, c) : this.b[b] = this.h(c)),
                        0 === this.d && r(d, this.b)
                    }
                    ,
                ...
                z.all = function (a, b) {
                    ...
                    z.race = function (a, b) {
                        ...
                        var e = new this(l, b);
                        if (!A(a))
                            return s(e, new TypeError("You must pass an array to race.")),
                                e;
                        for (var f = a.length, g = 0; void 0 === e.a && g < f; g++)
                            t(this.resolve(a[g]), void 0, c, d);
                        return e
                    }
                    ,
                ...
                var J = {
                    ...
                    polyfill: function () {
                        var b;
                        b = "undefined" != typeof d ? d : "undefined" != typeof a && a.document ? a : self,
                ...
                .call(a),
            a && a.ES6Promise.polyfill(),
            "undefined" == typeof b || "function" != typeof Object.create || "function" != typeof b.createElement("canvas").getContext)
            return void ((a || module.exports).html2canvas = function () {
        ...
        !function (a) {
            ...
            function C(a) {
                for (var e, f, b = [], c = 0, d = a.length; c < d;)
                    e = a.charCodeAt(c++),
                        e >= 55296 && e <= 56319 && c < d ? (f = a.charCodeAt(c++),
                            56320 == (64512 & f) ? b.push(((1023 & e) << 10) + (1023 & f) + 65536) : (b.push(e),
                                c--)) : b.push(e);
                return b
            }
            ...
            function H(a) {
                ...
                for (h = a.lastIndexOf(q),
                     h < 0 && (h = 0),
                         m = 0; m < h; ++m)
                    a.charCodeAt(m) >= 128 && z("not-basic"),
                        b.push(a.charCodeAt(m));
                for (n = h > 0 ? h + 1 : 0; n < c;) {
                    for (r = e,
                             s = 1,
                             t = j; n >= c && z("invalid-input"),
                             u = E(a.charCodeAt(n++)),
                         (u >= j || u > w((i - e) / s)) && z("overflow"),
                             e += u * s,
                             v = t <= g ? k : t >= g + l ? l : t - g,
                             !(u < v); t += j)
                        x = j - v,
        ...
        a.html2canvas = function (c, d) {
            var e = j++;
            if (d = d || {},
                d.logging && (a.html2canvas.logging = !0,
                    a.html2canvas.start = Date.now()),
                    d.async = "undefined" == typeof d.async || d.async,
                    d.allowTaint = "undefined" != typeof d.allowTaint && d.allowTaint,
                    d.removeContainer = "undefined" == typeof d.removeContainer || d.removeContainer,
                    d.javascriptEnabled = "undefined" != typeof d.javascriptEnabled && d.javascriptEnabled,
                    d.imageTimeout = "undefined" == typeof d.imageTimeout ? 1e4 : d.imageTimeout,
                    d.renderer = "function" == typeof d.renderer ? d.renderer : eb,
                    d.strict = !!d.strict,
                "string" == typeof c) {
                if ("string" != typeof d.proxy)
            ...
            return m.setAttribute(g + e, e),
                k(m.ownerDocument, d, m.ownerDocument.defaultView.innerWidth, m.ownerDocument.defaultView.innerHeight, e).then(function (a) {
                    if ("function" == typeof d.onrendered)
                        if (R("options.onrendered is deprecated, html2canvas returns a Promise containing the canvas"),
                            "undefined" == typeof d.grabMouse || d.grabMouse) {
                            var b = new Image(25, 25);
                            b.onload = function () {
                                a.getContext("2d").drawImage(b, hb, ib, 25, 25),
                                    d.onrendered(a)
                            }
                                ,
            ...
            ,
            a.html2canvas.punycode = this.punycode,
            a.html2canvas.proxy = {},
        ...
        L.prototype.getMetrics = function (a, b) {
            return this.data[a + "-" + b] === f && (this.data[a + "-" + b] = new K(a, b)),
                this.data[a + "-" + b]
        }
            ,
                ...
                return function (c) {
                    c.args.forEach(function (d) {
                        this.imageExists(a, d) || (a.splice(0, 0, b.call(this, c)),
                            R("Added image #" + a.length, "string" == typeof d ? d.substring(0, 100) : d))
                    }, this)
                }
            }
            ,
            ...
            P.prototype.fetch = function (a) {
                return this.images = a.reduce(Da(this.findBackgroundImage, this), this.findImages(a)),
            ...
            Q.prototype.stepRegExp = /((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/,
            S.prototype.cloneTo = function (a) {
            ...
            S.prototype.prefixedCss = function (a) {
                ...
                return c === f && b.some(function (b) {
                    return c = this.css(b + a.substr(0, 1).toUpperCase() + a.substr(1)),
                    c !== f
                }, this),
                    c === f ? null : c
            }
            ...
            S.prototype.parseBackgroundSize = function (a, b, c) {
                ...
                return f = "auto" === d[0] && "auto" === d[1] ? b.height : "auto" === d[1] ? e / b.width * b.height : V(d[1]) ? a.height * parseFloat(d[1]) / 100 : parseInt(d[1], 10),
            ...
            S.prototype.parseBackgroundPosition = function (a, b, c, d) {
                ...
                return f = V(e[0]) ? (a.width - (d || b).width) * (parseFloat(e[0]) / 100) : parseInt(e[0], 10),
                    g = "auto" === e[1] ? f / b.width * b.height : V(e[1]) ? (a.height - (d || b).height) * parseFloat(e[1]) / 100 : parseInt(e[1], 10),
                "auto" === e[0] && (f = g / b.height * b.width),
                    {
                        left: f,
                        top: g
                    }
            ...
            S.prototype.getValue = function () {
                ...
                return "SELECT" === this.node.tagName ? a = T(this.node) : "password" === this.node.type && (a = Array(a.length + 1).join("â€¢")),
                    0 === a.length ? this.node.placeholder || "" : a
            }
            ,
            S.prototype.MATRIX_PROPERTY = /(matrix)\((.+)\)/,
            S.prototype.TEXT_SHADOW_PROPERTY = /((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g,
            S.prototype.TEXT_SHADOW_VALUES = /(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g,
            S.prototype.CLIP = /^rect\((\d+)px,? (\d+)px,? (\d+)px,? (\d+)px\)$/,
            _.prototype.calculateOverflowClips = function () {
                this.nodes.forEach(function (a) {
                    if (ya(a)) {
                        ...
                        var b = "hidden" === a.css("overflow") ? [a.borders.clip] : []
                            , c = a.parseClip();
                        c && ["absolute", "fixed"].indexOf(a.css("position")) !== -1 && b.push([["rect", a.bounds.left + c.left, a.bounds.top + c.top, c.right - c.left, c.bottom - c.top]]),
                            a.clip = aa(a) ? a.parent.clip.concat(b) : b,
                            a.backgroundClip = "hidden" !== a.css("overflow") ? a.clip.concat([a.borders.clip]) : a.clip,
                        za(a) && a.cleanDOM()
                    } else
                        Aa(a) && (a.clip = aa(a) ? a.parent.clip : []);
                    za(a) || (a.bounds = null)
                }, this)
            }
            ,
            _.prototype.asyncRenderer = function (a, b, c) {
                c = c || Date.now(),
                    ...
                    a.length === this.renderIndex ? b() : c + 20 > Date.now() ? this.asyncRenderer(a, b, c) : setTimeout(Da(function () {
            ...
            _.prototype.getPseudoElement = function (a, c) {
                ...
                if (!d || !d.content || "none" === d.content || "-moz-alt-content" === d.content || "none" === d.display)
                    return null;
                for (var e = Ia(d.content), f = "url" === e.substr(0, 3),
                         g = b.createElement(f ? "img" : "html2canvaspseudoelement"), h = new Va(g, a, c),
                         i = d.length - 1; i >= 0; i--) {
                    var j = ba(d.item(i));
                    g.style[j] = d[j]
                }
                if (g.className = Va.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + Va.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER,
                        f)
                    return g.src = W(e)[0].args[0],
                        [h];
                var k = b.createTextNode(e);
                return g.appendChild(k),
                    [h, new ab(k, h)]
            }
            ,
            ...
            _.prototype.parse = function (a) {
                ...
                b.concat(e).concat(f).concat(g).concat(h).concat(i).concat(j).forEach(function (a) {
                    ...
                    oa(a) && (this.parse(a),
                        this.renderQueue.push(new ca))
                }, this)
            }
            ,
            _.prototype.paint = function (a) {
                try {
                    a instanceof ca ? this.renderer.ctx.restore() : Aa(a) ? (za(a.parent) && a.parent.appendToDOM(),
                        this.paintText(a),
                    za(a.parent) && a.parent.cleanDOM()) : this.paintNode(a)
                } catch (a) {
                    if (R(a),
                            this.options.strict)
                        throw a
            ...
            _.prototype.paintNode = function (a) {
                oa(a) && (this.renderer.setOpacity(a.opacity),
            ...
            _.prototype.paintCheckbox = function (a) {
                var b = a.parseBounds()
                    ...
                    , h = ga(d, f, g);
                this.renderer.clip(a.backgroundClip, function () {
                    this.renderer.rectangle(d.left + 1, d.top + 1, d.width - 2, d.height - 2, new D("#DEDEDE")),
                        this.renderer.renderBorders(ea(g, d, h, f)),
                    a.node.checked && (this.renderer.font(new D("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"),
                        this.renderer.text("âœ”", d.left + c / 6, d.top + c - 1))
                }, this)
            }
            ,
            _.prototype.paintRadio = function (a) {
                ...
                this.renderer.clip(a.backgroundClip, function () {
                    this.renderer.circleStroke(b.left + 1, b.top + 1, c, new D("#DEDEDE"), 1, new D("#A5A5A5")),
                    a.node.checked && this.renderer.circle(Math.ceil(b.left + c / 4) + 1, Math.ceil(b.top + c / 4) + 1, Math.floor(c / 2), new D("#424242"))
                }, this)
            }
            ,
            _.prototype.paintFormValue = function (a) {
                ...
                if (b.length > 0) {
                    ...
                    d.style.position = "fixed",
                        ...
                        this.paintText(new ab(d.firstChild, a)),
            ...
            _.prototype.paintText = function (b) {
                ...
                this.renderer.font(b.parent.color("color"), b.parent.css("fontStyle"), b.parent.css("fontVariant"), e, f, g),
                    h.length ? this.renderer.fontShadow(h[0].color, h[0].offsetX, h[0].offsetY, h[0].blur) : this.renderer.clearShadow(),
                    this.renderer.clip(b.parent.clip, function () {
                        d.map(this.parseTextBounds(b), this).forEach(function (a, c) {
                            a && (this.renderer.text(d[c], a.left, a.bottom),
                                this.renderTextDecoration(b.parent, a, this.fontMetrics.getMetrics(g, f)))
                        }, this)
                    }, this)
            }
            ,
        ...
        _.prototype.parseBorders = function (a) {
            ...
            _.prototype.parseBackgroundClip = function (a, b, c, d, e) {
                ...
                switch (f) {
                    case "content-box":
                    case "padding-box":
                        ja(g, d[0], d[1], b.topLeftInner, b.topRightInner, e.left + c[3].width, e.top + c[0].width),
                            ja(g, d[1], d[2], b.topRightInner, b.bottomRightInner, e.left + e.width - c[1].width, e.top + c[0].width),
                            ja(g, d[2], d[3], b.bottomRightInner, b.bottomLeftInner, e.left + e.width - c[1].width, e.top + e.height - c[2].width),
                            ja(g, d[3], d[0], b.bottomLeftInner, b.topLeftInner, e.left + c[3].width, e.top + e.height - c[2].width);
                        break;
                    default:
                        ja(g, d[0], d[1], b.topLeftOuter, b.topRightOuter, e.left, e.top),
                            ja(g, d[1], d[2], b.topRightOuter, b.bottomRightOuter, e.left + e.width, e.top),
                            ja(g, d[2], d[3], b.bottomRightOuter, b.bottomLeftOuter, e.left + e.width, e.top + e.height),
                            ja(g, d[3], d[0], b.bottomLeftOuter, b.topLeftOuter, e.left, e.top + e.height)
                }
                return g
            }
        ;
        ...
        Va.prototype.cloneTo = function (a) {
            Va.prototype.cloneTo.call(this, a),
                a.isPseudoElement = !0,
                a.before = this.before
        }
            ,
            Va.prototype = Object.create(S.prototype),
            Va.prototype.appendToDOM = function () {
            ...
            ,
            Va.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE = "___html2canvas___pseudoelement_before",
            Va.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER = "___html2canvas___pseudoelement_after",
            Wa.prototype.renderImage = function (a, b, c, d) {
            ...
            Xa.prototype.getParentStack = function (a) {
            ...
            Za.prototype.createCanvas = function (a) {
                ...
                return function (c, d) {
                    ...
                    b.image = e.lowerCanvasEl,
                        e.setWidth(d.width).setHeight(d.height).add(html2canvas.fabric.util.groupSVGElements(c, d)).renderAll(),
                        a(e.lowerCanvasEl)
                }
            }
            ,
            ...
            ,
            _a.prototype = Object.create(Za.prototype),
            ab.prototype = Object.create(S.prototype),
            ab.prototype.applyTextTransform = function () {
            ...
            eb.prototype.setFillStyle = function (a) {
            ...
            eb.prototype.taints = function (a) {
                if (null === a.tainted) {
                    ...
                    try {
                        ...
                        this.taintCtx = b.createElement("canvas").getContext("2d"),
                            a.tainted = !0
                    }
                }
                return a.tainted
            ...
            eb.prototype.clip = function (a, b, c) {
                this.ctx.save(),
                    a.filter(fb).forEach(function (a) {
                        this.shape(a).clip()
                    }, this),
                    b.call(c),
                    this.ctx.restore()
            ...
            eb.prototype.resizeImage = function (a, c) {
                ...
                return f.width = c.width,
                    f.height = c.height,
                    e = f.getContext("2d"),
                    e.drawImage(d, 0, 0, d.width, d.height, 0, 0, c.width, c.height),
                    f
            }
        ;
        var gb = !!b.all;
        gb || b.captureEvents(Event.MOUSEMOVE),
            b.addEventListener("mousemove", jb, !1);
        var hb = 0
            , ib = 0
    }
    ...
    function (window, document, exports, undefined) {
        ...
        var Cufon = function () {
            ...
            function f() {
                ...
                this.attach = function (a) {
                    a.onmouseenter === undefined ? (i(a, "mouseover", c),
                        i(a, "mouseout", c)) : (i(a, "mouseenter", d),
                        i(a, "mouseleave", d))
                }
            }
            ...
            function j(a, b) {
                var c = r.get(a);
                return c.options ? a : (b.hover && b.hoverables[a.nodeName.toLowerCase()] && s.attach(a),
                    c.options = b,
                    a)
            }
            ...
            function k(a) {
                var b = {};
                return function (c) {
                    return b.hasOwnProperty(c) || (b[c] = a.apply(null, arguments)),
                        b[c]
                }
            }
            ...
            function l(a, b) {
                b || (b = c.getStyle(a));
                for (var e, d = c.quotedList(b.get("fontFamily").toLowerCase()), f = 0, g = d.length; f < g; ++f)
                    if (e = d[f],
                            v[e])
                        return v[e].get(b.get("fontStyle"), b.get("fontWeight"));
                return null
            }
            ...
            function n() {
                for (var b, a = {}, c = 0, d = arguments.length; c < d; ++c)
                    for (b in arguments[c])
                        a[b] = arguments[c][b];
                return a
            }
            ...
            function o(a, b, d, e, f, g) {
                var h = e.separate;
                if ("none" == h)
                    return u[e.engine].apply(null, arguments);
                var j, i = fabric.document.createDocumentFragment(), k = b.split(x[h]), l = "words" == h;
                l && q && (/^\s/.test(b) && k.unshift(""),
                /\s$/.test(b) && k.push(""));
                for (var m = 0, n = k.length; m < n; ++m)
                    j = u[e.engine](a, l ? c.textAlign(k[m], d, m, n) : k[m], d, e, f, g, m < n - 1),
                    j && i.appendChild(j);
                return i
            }
            ...
            function p(a, b) {
                for (var d, e, f, g, h = j(a, b).firstChild; h; h = f) {
                    ...
                    if (e || (e = c.getStyle(a).extend(b)),
                        d || (d = l(a, e)),
                            d)
                        if (g)
                            u[b.engine](d, null, e, b, h, a);
                        else {
                            var i = h.data;
            ...
            var a = function () {
                ...
                ready: function () {
                    ...
                    return fabric.document.addEventListener && (fabric.document.addEventListener("DOMContentLoaded", d, !1),
                        fabric.window.addEventListener("pageshow", d, !1)),
                    !fabric.window.opera && fabric.document.readyState && function () {
                ...
                quotedList: k(function (a) {
                    for (var d, b = [], c = /\s*((["'])([\s\S]*?[^\\])\2|[^,]+)\s*/g; d = c.exec(a);)
                        b.push(d[3] || d[1]);
                    return b
                }),
                ready: function () {
                    var a = !1
                        ...
                        , e = Object.prototype.propertyIsEnumerable ? m("style") : {
                        length: 0
                    }
                        , f = m("link");
                    return b.ready(function () {
                        for (var b, a = 0, c = 0, g = f.length; b = f[c],
                        c < g; ++c)
                            b.disabled || "stylesheet" != b.rel.toLowerCase() || ++a;
                ...
                supports: function (a, b) {
                    ...
                    return c[a] !== undefined && (c[a] = b,
                        c[a] === b)
                },
                textAlign: function (a, b, c, d) {
                    return "right" == b.get("textAlign") ? c > 0 && (a = " " + a) : c < d - 1 && (a += " "),
                        a
                },
                textDecoration: function (a, b) {
                    ...
                    for (var c = {
                        ...
                        var e = !0;
                        for (var f in c)
                            c[f] || (b.get("textDecoration").indexOf(f) != -1 && (c[f] = b.get("color")),
                                e = !1);
                        if (e)
                            break;
                ...
                textShadow: k(function (a) {
                    if ("none" == a)
                        return null;
                    for (var d, b = [], c = {}, e = 0,
                             f = /(#[a-f0-9]+|[a-z]+\(.*?\)|[a-z]+)|(-?[\d.]+[a-z%]*)|,/gi; d = f.exec(a);)
                        "," == d[0] ? (b.push(c),
                            c = {},
                            e = 0) : d[1] ? c.color = d[1] : c[["offX", "offY", "blur"][e++]] = d[2];
                    return b.push(c),
                        b
                }),
                color: k(function (a) {
            ...
            return a.now = function () {
                ...
                ,
                a.refresh = function () {
                    for (var b = t.splice(0, t.length), c = 0, d = b.length; c < d; ++c)
                        a.replace.apply(null, b[c]);
                    return a
                }
                ,
                ...
                a.replace = function (b, d, e) {
                    return d = n(w, d),
                        d.engine ? ("string" == typeof d.textShadow && d.textShadow && (d.textShadow = c.textShadow(d.textShadow)),
                        e || t.push(arguments),
                        (b.nodeType || "string" == typeof b) && (b = [b]),
                            c.ready(function () {
                ...
                a.replaceElement = function (a, b) {
                    return b = n(w, b),
                    "string" == typeof b.textShadow && b.textShadow && (b.textShadow = c.textShadow(b.textShadow)),
                        p(a, b)
                }
                ,
                a.engines = u,
        ...
        Cufon.registerEngine("canvas", function () {
            ...
            try {
                ...
                c.setAttribute("type", "text/css"),
                    c.styleSheet.cssText = d.data
            }
            return fabric.document.getElementsByTagName("head")[0].appendChild(c),
                function (b, c, d, g, h, i) {
                    function Y() {
                        ...
                        g.backgroundColor && (S.save(),
                            S.fillStyle = g.backgroundColor,
                            S.translate(0, b.ascent),
                            S.fillRect(0, 0, z + 10, (-b.ascent + b.descent) * C),
                            S.restore()),
                            "right" === g.textAlign ? (S.translate(F[c], 0),
                                d[0].left = F[c] * T) : "center" === g.textAlign && (S.translate(F[c] / 2, 0),
                                    d[0].left = F[c] / 2 * T);
                        for (var e = 0, f = y.length; e < f; ++e)
                            if ("\n" !== y[e]) {
                                var k = b.glyphs[y[e]] || b.missingGlyph;
                                if (k) {
                                    var l = Number(k.w || b.w) + m;
                                    g.textBackgroundColor && (S.save(),
                                        S.fillStyle = g.textBackgroundColor,
                                        S.translate(0, b.ascent),
                                        S.fillRect(0, 0, l + 10, -b.ascent + b.descent),
                                        S.restore()),
                                        S.translate(l, 0),
                                        a += l,
                                    e == f - 1 && (d[d.length - 1].width = a * T,
                                        d[d.length - 1].height = (-b.ascent + b.descent) * T)
                                }
                            } else {
                                c++;
                                var h = -b.ascent - b.ascent / 5 * g.lineHeight
                                    , i = d[d.length - 1]
                                    , j = {
                                    left: 0
                                };
                                i.width = a * T,
                                    i.height = (-b.ascent + b.descent) * T,
                                    "right" === g.textAlign ? (S.translate(-z, h),
                                        S.translate(F[c], 0),
                                        j.left = F[c] * T) : "center" === g.textAlign ? (S.translate(-a - F[c - 1] / 2, h),
                                        S.translate(F[c] / 2, 0),
                                        j.left = F[c] / 2 * T) : S.translate(-a, h),
                                    d.push(j),
                                    a = 0
                            }
                        S.restore(),
                            Cufon.textOptions.boundaries = d
                    }
                            ...
                            if ("\n" !== y[i]) {
                                ...
                                if (l) {
                                    ...
                                    W && (S.save(),
                                        ...
                                        S.beginPath(),
                                    W.underline && (S.moveTo(0, -b.face["underline-position"] + .5),
                                        S.lineTo(n, -b.face["underline-position"] + .5)),
                                    W.overline && (S.moveTo(0, b.ascent + .5),
                                        S.lineTo(n, b.ascent + .5)),
                                    W["line-through"] && (S.moveTo(0, -b.descent + .5),
                                        S.lineTo(n, -b.descent + .5)),
                                        S.stroke(),
                                        S.restore()),
                                    X && (S.save(),
                                        S.transform(1, 0, -.25, 1, 0, 0)),
                                        S.beginPath(),
                                    l.d && (l.code ? f(l.code, S) : l.code = e("m" + l.d, S)),
                                        S.fill(),
                                    g.strokeStyle && (S.closePath(),
                                        S.save(),
                                        S.lineWidth = g.strokeWidth,
                                        S.strokeStyle = g.strokeStyle,
                                        S.stroke(),
                                        S.restore()),
                                    X && S.restore(),
                                        S.translate(n, 0),
                                ...
                                "right" === g.textAlign ? (S.translate(-z, k),
                                    S.translate(F[h], 0)) : "center" === g.textAlign ? (S.translate(-c - F[h - 1] / 2, k),
                                    S.translate(F[h] / 2, 0)) : S.translate(-c, k),
                                    c = 0
                            }
                    }
                    ...
                    var j = null === c
                        , k = b.viewBox
                        , l = d.getSize("fontSize", b.baseSize)
                        , m = d.get("letterSpacing");
                    ...
                    var n = 0
                        ...
                        , r = g.textShadow
                        , s = [];
                    if (Cufon.textOptions.shadowOffsets = [],
                            Cufon.textOptions.shadows = null,
                            r) {
                        Cufon.textOptions.shadows = r;
                        for (var t = 0, u = r.length; t < u; ++t) {
                            var v = r[t]
                                , w = l.convertFrom(parseFloat(v.offX))
                                , x = l.convertFrom(parseFloat(v.offY));
                            s[t] = [w, x]
                        }
                    }
                    for (var y = Cufon.CSS.textTransform(j ? h.alt : c, d).split(""), z = 0, A = null, B = 0, C = 1,
                             D = [], t = 0, u = y.length; t < u; ++t)
                        if ("\n" !== y[t]) {
                    ...
                    if (j)
                        G = h,
                            H = h.firstChild;
                    else if (G = fabric.document.createElement("span"),
                            G.className = "cufon cufon-canvas",
                            G.alt = c,
                            H = fabric.document.createElement("canvas"),
                            G.appendChild(H),
                            g.printable) {
                        var I = fabric.document.createElement("span");
                        I.className = "cufon-alt",
                            I.appendChild(fabric.document.createTextNode(c)),
                            G.appendChild(I)
                    }
                    var J = G.style
                        , K = H.style || {}
                        , L = l.convert(k.height - n + p)
                        , M = Math.ceil(L)
                        , N = M / L;
                    H.width = Math.ceil(l.convert(z + o - q) * N),
                        H.height = M,
                        n += k.minY,
                        K.top = Math.round(l.convert(n - b.ascent)) + "px",
                        K.left = Math.round(l.convert(q)) + "px";
                    var O = Math.ceil(l.convert(z * N))
                        , P = O + "px"
                        , Q = l.convert(b.height)
                        , R = (g.lineHeight - 1) * l.convert(-b.ascent / 5) * (C - 1);
                    Cufon.textOptions.width = O,
                        Cufon.textOptions.height = Q * C + R,
                        Cufon.textOptions.lines = C,
                        Cufon.textOptions.totalLineHeight = R,
                        a ? (J.width = P,
                            J.height = Q + "px") : (J.paddingLeft = P,
                            J.paddingBottom = Q - 1 + "px");
                    var S = Cufon.textOptions.context || H.getContext("2d")
                        , T = M / k.height;
                    Cufon.textOptions.fontAscent = b.ascent * T,
                        Cufon.textOptions.boundaries = null;
                    for (var U = Cufon.textOptions.shadowOffsets, t = s.length; t--;)
                        U[t] = [s[t][0] * T, s[t][1] * T];
                    S.save(),
                        S.scale(T, T),
                        S.translate(-q - 1 / T * H.width / 2 + (Cufon.fonts[b.family].offsetLeft || 0), -n - Cufon.textOptions.height / T / 2 + (Cufon.fonts[b.family].offsetTop || 0)),
                        S.lineWidth = b.face["underline-thickness"],
                        S.save();
            ...
            Cufon.registerEngine("vml", function () {
                ...
                if (fabric.document.namespaces) {
                    ...
                    if (!(a && a.getContext && a.getContext.apply)) {
                        ...
                        if (b.style.behavior = "url(#default#VML)",
                                b.coordsize)
                            return b = null,
                                ...
                                function (a, b, e, f, g, h, i) {
                                    ...
                                    m == undefined && (m = e.get("letterSpacing"),
                                        e.computedLSpacing = m = "normal" == m ? 0 : ~~l.convertFrom(d(h, m)));
                                    var n, o;
                                    if (j)
                                        n = g,
                                            o = g.firstChild;
                                    else {
                                        if (n = fabric.document.createElement("span"),
                                            ...
                                            p.className = "cufon-alt",
                                                p.appendChild(fabric.document.createTextNode(b)),
                                                n.appendChild(p)
                                        }
                                    ...
                                    var q = n.style
                                        ...
                                        , w = k.minY;
                                    r.height = t,
                                        r.top = Math.round(l.convert(w - a.ascent)),
                                        r.left = Math.round(l.convert(v)),
                                        q.height = l.convert(a.height) + "px";
                                    for (var D, E, y = (Cufon.getTextDecoration(f),
                                            e.get("color")), z = Cufon.CSS.textTransform(b, e).split(""), A = 0, B = 0,
                                             C = null, F = f.textShadow, G = 0, H = 0, I = z.length; G < I; ++G)
                                        D = a.glyphs[z[G]] || a.missingGlyph,
                                        D && (A += C = ~~(D.w || a.w) + m);
                                    if (null === C)
                                        return null;
                                    var N, J = -v + A + (k.width - C), K = l.convert(J * u), L = Math.round(K),
                                        M = J + "," + k.height, O = "r" + M + "nsnf";
                                    for (G = 0; G < I; ++G)
                                        if (D = a.glyphs[z[G]] || a.missingGlyph) {
                                            j ? (E = o.childNodes[H],
                                            E.firstChild && E.removeChild(E.firstChild)) : (E = fabric.document.createElement("cvml:shape"),
                                                o.appendChild(E)),
                                                E.stroked = "f",
                                                E.coordsize = M,
                                                E.coordorigin = N = v - B + "," + w,
                                                E.path = (D.d ? "m" + D.d + "xe" : "") + "m" + N + O,
                                                E.fillcolor = y;
                                            var P = E.style;
                                            if (P.width = L,
                                                    P.height = t,
                                                ...
                                                U.on = "t",
                                                    U.color = S.color,
                                                    U.offset = Q.offX + "," + Q.offY,
                                                R && (T = Cufon.CSS.color(R.color),
                                                    U.type = "double",
                                                    U.color2 = T.color,
                                                    U.offset2 = R.offX + "," + R.offY),
                                                    U.opacity = S.opacity || T && T.opacity || 1,
                                                    E.appendChild(U)
                                            }
                                            B += ~~(D.w || a.w) + m,
                                                ++H
                                        }
                                    return q.width = Math.max(Math.ceil(l.convert(A * u)), 0),
                                        n
                                }
                    }
                }
        ...
        "object" != typeof JSON && (JSON = {}),
            ...
            fabric.Collection = {
                ...
                remove: function () {
                    for (var b, a = this.getObjects(), c = 0, d = arguments.length; c < d; c++)
                        b = a.indexOf(arguments[c]),
                        b !== -1 && (a.splice(b, 1),
                            this._onObjectRemoved(arguments[c]));
                    return this.renderOnAddRemove && this.renderAll(),
                        this
                },
            ...
            function (a) {
                ...
                fabric.util = {
                    ...
                    invertTransform: function (a) {
                        ...
                        var d = fabric.util.transformPoint({
                            x: a[4],
                            y: a[5]
                        }, b);
                        return b[4] = -d.x,
                    ...
                    getKlass: function (a, b) {
                        return a = fabric.util.string.camelize(a.charAt(0).toUpperCase() + a.slice(1)),
                            fabric.util.resolveNamespace(b)[a]
                    },
                    resolveNamespace: function (b) {
                        if (!b)
                            return fabric;
                        for (var c = b.split("."), d = c.length, e = a || fabric.window, f = 0; f < d; ++f)
                            e = e[c[f]];
                        return e
                    },
                    loadImage: function (a, b, c, d) {
                        if (!a)
                            return void (b && b.call(c, a));
                        ...
                        e.onload = function () {
                            ...
                            ,
                            e.onerror = function () {
                                fabric.log("Error loading " + e.src),
                                b && b.call(c, null, !0),
                                    e = e.onload = e.onerror = null
                            }
                            ,
                        0 !== a.indexOf("data") && "undefined" != typeof d && (e.crossOrigin = d),
                            e.src = a
                    },
                    ...
                    groupSVGElements: function (a, b, c) {
                        var d;
                        return d = new fabric.PathGroup(a, b),
                    ...
                    drawDashedLine: function (a, d, e, f, g, h) {
                        ...
                        for (a.save(),
                            ...
                            d += h[n++ % m],
                            d > k && (d = k),
                                a[o ? "lineTo" : "moveTo"](d, 0),
                                o = !o;
                        a.restore()
                    },
                    createCanvasElement: function (a) {
                        return a || (a = fabric.document.createElement("canvas")),
                        a.getContext || "undefined" == typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(a),
                            a
                    },
                    ...
                    multiplyTransformMatrices: function (a, b) {
                        for (var c = [[a[0], a[2], a[4]], [a[1], a[3], a[5]], [0, 0, 1]],
                                 d = [[b[0], b[2], b[4]], [b[1], b[3], b[5]], [0, 0, 1]], e = [], f = 0; f < 3; f++) {
                            e[f] = [];
                            for (var g = 0; g < 3; g++) {
                                for (var h = 0, i = 0; i < 3; i++)
                                    h += c[f][i] * d[i][g];
                                e[f][g] = h
                            }
                        }
                    ...
                    isTransparent: function (a, b, c, d) {
                        d > 0 && (b > d ? b -= d : b = 0,
                            c > d ? c -= d : c = 0);
                        for (var e = !0, f = a.getImageData(b, c, 2 * d || 1, 2 * d || 1), g = 3,
                                 h = f.data.length; g < h; g += 4) {
                            var i = f.data[g];
                            if (e = i <= 0,
                                e === !1)
                                break
            ...
            function () {
                function d(b, d, g, h, i, j, k) {
                    ...
                    if (y < 0) {
                        ...
                        z = (i === j ? -.5 : .5) * Math.sqrt(y / (u * w + v * x));
                    var B = z * g * t / h
                        , C = -z * h * s / g
                        , D = p * B - o * C + b / 2
                        , E = o * B + p * C + d / 2
                        , F = f(1, 0, (s - B) / g, (t - C) / h)
                        , G = f((s - B) / g, (t - C) / h, (-s - B) / g, (-t - C) / h);
                    0 === j && G > 0 ? G -= 2 * m : 1 === j && G < 0 && (G += 2 * m);
                    for (var H = Math.ceil(Math.abs(G / (.5 * m))), I = [], J = G / H,
                             K = 8 / 3 * Math.sin(J / 4) * Math.sin(J / 4) / Math.sin(J / 2), L = F + J,
                             M = 0; M < H; M++)
                        I[M] = e(F, L, p, o, g, h, D, E, K, q, r),
                            q = I[M][4],
                            r = I[M][5],
                            F += J,
                            L += J;
                ...
                fabric.util.drawArc = function (a, b, c, e) {
                    for (var f = e[0], g = e[1], h = e[2], i = e[3], j = e[4], k = e[5], l = e[6], m = [[], [], [], []],
                             n = d(k - b, l - c, f, g, i, j, h), o = 0, p = n.length; o < p; o++)
                        m[o][0] = n[o][0] + b,
                            m[o][1] = n[o][1] + c,
                            m[o][2] = n[o][2] + b,
                            m[o][3] = n[o][3] + c,
            ...
            function () {
                function b(b, c) {
                    for (var d = a.call(arguments, 2), e = [], f = 0, g = b.length; f < g; f++)
                        e[f] = d.length ? b[f][c].apply(b[f], d) : b[f][c].call(b[f]);
                    return e
                }
            ...
            function () {
                ...
                function g() {
                    ...
                    "function" == typeof g[0] && (c = g.shift()),
                        h.superclass = c,
                        h.subclasses = [],
                    c && (e.prototype = c.prototype,
                        h.prototype = new e,
                        c.subclasses.push(h));
                    for (var i = 0, j = g.length; i < j; i++)
                        d(h, g[i], c);
                    return h.prototype.initialize || (h.prototype.initialize = b),
                        h.prototype.constructor = h,
                        h.prototype.callSuper = f,
                        h
                }
                ...
                var a = Array.prototype.slice
                    ...
                    , d = function (a, b, d) {
                    for (var e in b)
                        e in a.prototype && "function" == typeof a.prototype[e] && (b[e] + "").indexOf("callSuper") > -1 ? a.prototype[e] = function (a) {
                            return function () {
                                var c = this.constructor.superclass;
                                this.constructor.superclass = d;
                                var e = b[a].apply(this, arguments);
                                if (this.constructor.superclass = c,
                                    "initialize" !== a)
                                    return e
                            }
                        }(e) : a.prototype[e] = b[e],
                        c && (b.toString !== Object.prototype.toString && (a.prototype.toString = b.toString),
            ...
            function () {
                function b(a) {
                    ...
                    for (d = 0; d < e; d++)
                        if (c = typeof a[b[d]],
                                !/^(?:function|object|unknown)$/.test(c))
                            return !1;
                    return !0
                }
                ...
                function h(a, b) {
                    return function (c) {
                        if (l[a] && l[a][b])
                            for (var d = l[a][b], e = 0, f = d.length; e < f; e++)
                ...
                i ? (m = function (a, b, c) {
                        ...
                        var h = f(g, c);
                        k[g][b].push(h),
                            a.attachEvent("on" + b, h.wrappedHandler)
                    }
                        ,
                        n = function (a, b, c) {
                            var f, d = e(a);
                            if (k[d] && k[d][b])
                                for (var g = 0, h = k[d][b].length; g < h; g++)
                                    f = k[d][b][g],
                                    f && f.handler === c && (a.detachEvent("on" + b, f.wrappedHandler),
                                        k[d][b][g] = null)
                        }
                ) : (m = function (a, b, c) {
                        var d = e(a);
                        ...
                        n = function (a, b, c) {
                            var d = e(a);
                            if (l[d] && l[d][b])
                                for (var f = l[d][b], g = 0, h = f.length; g < h; g++)
                                    f[g] === c && f.splice(g, 1)
                        }
                ),
                    fabric.util.addListener = m,
                    fabric.util.removeListener = n;
                var p = function (b) {
                ...
                function a(a, b) {
                    ...
                    if ("string" == typeof b)
                        return a.style.cssText += ";" + b,
                            b.indexOf("opacity") > -1 ? f(a, b.match(/opacity:\s*(\d?\.?\d*)/)[1]) : a;
                    for (var d in b)
                        if ("opacity" === d)
                            f(a, b[d]);
                        else {
                ...
                c ? f = function (a, b) {
                    ...
                    : d && (f = function (a, b) {
                            ...
                            return a.currentStyle && !a.currentStyle.hasLayout && (c.zoom = 1),
                                e.test(c.filter) ? (b = b >= .9999 ? "" : "alpha(opacity=" + 100 * b + ")",
                                    c.filter = c.filter.replace(e, b)) : c.filter += " alpha(opacity=" + 100 * b + ")",
                                a
                        }
                    ),
            ...
            function () {
                ...
                function e(a, b) {
                    ...
                    for (var d in b)
                        "class" === d ? c.className = b[d] : "for" === d ? c.htmlFor = b[d] : c.setAttribute(d, b[d]);
                    return c
                }
                ...
                function g(a, b, c) {
                    return "string" == typeof b && (b = e(b, c)),
                ...
                function h(a, b) {
                    var c, d, e = 0, f = 0, g = fabric.document.documentElement, h = fabric.document.body || {
                            scrollLeft: 0,
                            scrollTop: 0
                        };
                    for (d = a; a && a.parentNode && !c;)
                        a = a.parentNode,
                        a !== fabric.document && "fixed" === fabric.util.getElementStyle(a, "position") && (c = a),
                            a !== fabric.document && d !== b && "absolute" === fabric.util.getElementStyle(a, "position") ? (e = 0,
                                f = 0) : a === fabric.document ? (e = h.scrollLeft || g.scrollLeft || 0,
                                f = h.scrollTop || g.scrollTop || 0) : (e += a.scrollLeft || 0,
                                f += a.scrollTop || 0);
                    return {
                        left: e,
                        top: f
                ...
                j = fabric.document.defaultView && fabric.document.defaultView.getComputedStyle ? function (a, b) {
                    ...
                    function () {
                        function c(a) {
                            return "undefined" != typeof a.onselectstart && (a.onselectstart = fabric.util.falseFunction),
                                b ? a.style[b] = "none" : "string" == typeof a.unselectable && (a.unselectable = "on"),
                                a
                        }

                        function d(a) {
                            return "undefined" != typeof a.onselectstart && (a.onselectstart = null),
                                b ? a.style[b] = "" : "string" == typeof a.unselectable && (a.unselectable = ""),
                                a
                        }
                        ...
                        fabric.util.makeElementUnselectable = c,
                            fabric.util.makeElementSelectable = d
                    }(),
                    function () {
                        function a(a, b) {
            ...
            function () {
                ...
                function d(d, e) {
                    ...
                    return h.onreadystatechange = function () {
                        ...
                        ,
                    "GET" === f && (i = null,
                    "string" == typeof e.parameters && (d = a(d, e.parameters))),
                        h.open(f, d, !0),
        ...
        "undefined" != typeof console && ["log", "warn"].forEach(function (a) {
            ...
            function (a) {
                ...
                function l(a, c, d) {
                    ...
                    return "fill" !== a && "stroke" !== a || "none" !== c ? "fillRule" === a ? c = "evenodd" === c ? "destination-over" : c : "strokeDashArray" === a ? c = c.replace(/,/g, " ").split(/\s+/).map(function (a) {
                        return parseInt(a)
                    }) : "transformMatrix" === a ? c = d && d.transformMatrix ? h(d.transformMatrix, b.parseTransformAttribute(c)) : b.parseTransformAttribute(c) : "visible" === a ? (c = "none" !== c && "hidden" !== c,
                    d && d.visible === !1 && (c = !1)) : "originX" === a ? c = "start" === c ? "left" : "end" === c ? "right" : "center" : f = e ? c.map(g) : g(c) : c = "",
                        !e && isNaN(f) ? c : f
                }

                function m(a) {
                    for (var c in j)
                        if (a[c] && "undefined" != typeof a[j[c]] && 0 !== a[c].indexOf("url(")) {
                ...
                function p(a, b) {
                    var c, d;
                    for (var e in a)
                        "undefined" != typeof a[e] && (c = k(e.toLowerCase()),
                            d = l(c, a[e]),
                            "font" === c ? n(d, b) : b[c] = d)
                }
                ...
                function q(a) {
                    var c = {};
                    for (var d in b.cssRules)
                        if (r(a, d.split(" ")))
                            for (var e in b.cssRules[d])
                                c[e] = b.cssRules[d][e];
                    return c
                }
                ...
                function t(a, b) {
                    ...
                    if (f = new RegExp("^" + c, "i"),
                            b = b.replace(f, ""),
                        e && b.length && (f = new RegExp("#" + e + "(?![a-zA-Z\\-]+)", "i"),
                            b = b.replace(f, "")),
                        d && b.length) {
                        d = d.split(" ");
                        for (var g = d.length; g--;)
                            f = new RegExp("\\." + d[g] + "(?![a-zA-Z\\-]+)", "i"),
                                b = b.replace(f, "")
                    }
                    return 0 === b.length
                }
                ...
                function u(a) {
                    for (var b = a.getElementsByTagName("use"); b.length;) {
                        for (var i, c = b[0], d = c.getAttribute("xlink:href").substr(1), e = c.getAttribute("x") || 0,
                                 f = c.getAttribute("y") || 0, g = a.getElementById(d).cloneNode(!0),
                                 h = (c.getAttribute("transform") || "") + " translate(" + e + ", " + f + ")", j = 0,
                                 k = c.attributes, l = k.length; j < l; j++) {
                            var m = k.item(j);
                ...
                function v(a, b) {
                    if (b[3] = b[0] = b[0] > b[3] ? b[3] : b[0],
                        1 !== b[0] || 1 !== b[3] || 0 !== b[4] || 0 !== b[5]) {
                        for (var c = a.ownerDocument.createElement("g"); null != a.firstChild;)
                            c.appendChild(a.firstChild);
                        c.setAttribute("transform", "matrix(" + b[0] + " " + b[1] + " " + b[2] + " " + b[3] + " " + b[4] + " " + b[5] + ")"),
                            a.appendChild(c)
                    }
                }
                ...
                var b = a.fabric || (a.fabric = {})
                    ...
                    , d = b.util.string.capitalize
                    , e = b.util.object.clone
                    , f = b.util.toFixed
                    , g = b.util.parseUnit
                    , h = b.util.multiplyTransformMatrices
                    , i = {
                    cx: "left",
                    x: "left",
                    r: "radius",
                    ...
                    return function (h) {
                        ...
                        h.replace(t, function (h) {
                            var k = new RegExp(p).exec(h).filter(function (a) {
                                ...
                                , l = k[1]
                                , m = k.slice(2).map(parseFloat);
                            switch (l) {
                                case "translate":
                                    f(i, m);
                                    break;
                                case "rotate":
                                    m[0] = b.util.degreesToRadians(m[0]),
                                        a(i, m);
                                    break;
                                case "scale":
                                    c(i, m);
                        ...
                        for (var k = j[0]; j.length > 1;)
                            j.shift(),
                                k = b.util.multiplyTransformMatrices(k, j[0]);
                        return k
                    }
                }(),
                        ...
                        return function (c, h, i) {
                            if (c) {
                                ...
                                if (0 === t.length && b.isLikelyNode) {
                                    ...
                                    for (var w = [], x = 0, y = t.length; x < y; x++)
                                        w[x] = t[x];
                                    t = w
                                }
                                ...
                                b.gradientDefs = b.getGradientDefs(c),
                                    b.cssRules = b.getCSSRules(c),
                                    b.parseElements(z, function (a) {
                                        b.documentParsingTime = new Date - j,
                                        h && h(a, A)
                                    }, e(A), i)
                            }
                        }
                ...
                c(b, {
                    getGradientDefs: function (a) {
                        ...
                        for (i.length = b.length + c.length,
                                 e = b.length; e--;)
                            i[f++] = b[e];
                        for (e = c.length; e--;)
                            i[f++] = c[e];
                        for (; f--;)
                            d = i[f],
                                h = d.getAttribute("xlink:href"),
                                g = d.getAttribute("id"),
                            h && (k[g] = h.substr(1)),
                                j[g] = d;
                        for (g in k) {
                            var l = j[k[g]].cloneNode(!0);
                            for (d = j[g]; l.firstChild;)
                    ...
                    parseAttributes: function (a, d) {
                        if (a) {
                            ...
                            var g = d.reduce(function (b, c) {
                                return e = a.getAttribute(c),
                                e && (c = k(c),
                                    e = l(c, e, f),
                                    b[c] = e),
                                    b
                            }, {});
                            return g = c(g, c(q(a), b.parseStyleAttribute(a))),
                                m(c(f, g))
                        }
                    },
                    ...
                    parseStyleAttribute: function (a) {
                        ...
                        return c ? ("string" == typeof c ? o(c, b) : p(c, b),
                            b) : b
                    },
                        ...
                        for (var e, c = a.getElementsByTagName("style"), d = {}, f = 0, g = c.length; f < g; f++) {
                            ...
                            h = h.replace(/\/\*[\s\S]*?\*\//g, ""),
                                ...
                                e.forEach(function (a) {
                                    for (var c = a.match(/([\s\S]*?)\s*\{([^}]*)\}/), e = {}, f = c[2].trim(),
                                             g = f.replace(/;$/, "").split(/\s*;\s*/), h = 0,
                                             i = g.length; h < i; h++) {
                                        var j = g[h].split(/\s*:\s*/)
                                            , m = k(j[0])
                                            , n = l(m, j[1], j[0]);
                    ...
                    loadSVGFromURL: function (a, c, d) {
                        function e(e) {
                            var f = e.responseXML;
                            f && !f.documentElement && b.window.ActiveXObject && e.responseText && (f = new ActiveXObject("Microsoft.XMLDOM"),
                                f.async = "false",
                                f.loadXML(e.responseText.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, ""))),
                            f && f.documentElement && b.parseSVGDocument(f.documentElement, function (d, e) {
                                w.set(a, {
                                    objects: b.util.array.invoke(d, "toObject"),
                                    options: e
                                }),
                                    c(d, e)
                            }, d)
                    ...
                    loadSVGFromString: function (a, c, d) {
                        ...
                        if ("undefined" != typeof DOMParser) {
                            ...
                            b.window.ActiveXObject && (e = new ActiveXObject("Microsoft.XMLDOM"),
                                e.async = "false",
                                e.loadXML(a.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, "")));
                    ...
                    createSVGFontFacesMarkup: function (a) {
                        for (var b = "", c = 0, d = a.length; c < d; c++)
                            "text" === a[c].type && a[c].path && (b += ["@font-face {", "font-family: ", a[c].fontFamily, "; ", "src: url('", a[c].path, "')", "}"].join(""));
                        return b && (b = ['<style type="text/css">', "<![CDATA[", b, "]]>", "</style>"].join("")),
                            b
                    },
                    createSVGRefElementsMarkup: function (a) {
                        var b = [];
                        return y(b, a, "backgroundColor"),
                            y(b, a, "overlayColor"),
                            b.join("")
                    }
                })
            }("undefined" != typeof exports ? exports : this),
            fabric.ElementsParser = function (a, b, c, d) {
                this.elements = a,
                    this.callback = b,
                    this.options = c,
                    this.reviver = d
            ...
            function (a) {
                ...
                var b = a.fabric || (a.fabric = {});
                return b.Point ? void b.warn("fabric.Point is already defined") : (b.Point = c,
                    void (c.prototype = {
                        constructor: c,
                        add: function (a) {
            ...
            function (a) {
                ...
                var b = a.fabric || (a.fabric = {});
                return b.Intersection ? void b.warn("fabric.Intersection is already defined") : (b.Intersection = c,
                    ...
                    b.Intersection.intersectLineLine = function (a, d, e, f) {
                        ...
                        if (0 !== j) {
                            var k = h / j
                                , l = i / j;
                            0 <= k && k <= 1 && 0 <= l && l <= 1 ? (g = new c("Intersection"),
                                g.points.push(new b.Point(a.x + k * (d.x - a.x), a.y + k * (d.y - a.y)))) : g = new c
                        } else
                            g = new c(0 === h || 0 === i ? "Coincident" : "Parallel");
                        return g
                    }
                    ,
                    ...
                    b.Intersection.intersectPolygonPolygon = function (a, b) {
                        for (var d = new c, e = a.length, f = 0; f < e; f++) {
                            var g = a[f]
                                , h = a[(f + 1) % e]
                                , i = c.intersectLinePolygon(g, h, b);
                    ...
                    void (b.Intersection.intersectPolygonRectangle = function (a, d, e) {
                            var f = d.min(e)
                                , g = d.max(e)
                                , h = new b.Point(g.x, f.y)
                                , i = new b.Point(f.x, g.y)
                                , j = c.intersectLinePolygon(f, h, a)
                                , k = c.intersectLinePolygon(h, g, a)
                                , l = c.intersectLinePolygon(g, i, a)
                                , m = c.intersectLinePolygon(i, f, a)
                                , n = new c;
            ...
            function (a) {
                ...
                var b = a.fabric || (a.fabric = {});
                return b.Color ? void b.warn("fabric.Color is already defined.") : (b.Color = c,
                    b.Color.prototype = {
                        _tryParsingColor: function (a) {
                            var b;
                            return a in c.colorNameMap && (a = c.colorNameMap[a]),
                                "transparent" === a ? void this.setSource([255, 255, 255, 0]) : (b = c.sourceFromHex(a),
                                b || (b = c.sourceFromRgb(a)),
                                b || (b = c.sourceFromHsl(a)),
                                    void (b && this.setSource(b)))
                        },
                        ...
                        overlayWith: function (a) {
                            ...
                            for (var b = [], d = this.getAlpha(), e = .5, f = this.getSource(), g = a.getSource(),
                                     h = 0; h < 3; h++)
                                b.push(Math.round(f[h] * (1 - e) + g[h] * e));
                            return b[3] = d,
                                this.setSource(b),
                                this
                        }
                    },
                    b.Color.reRGBa = /^rgba?\(\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
                    b.Color.reHSLa = /^hsla?\(\s*(\d{1,3})\s*,\s*(\d{1,3}\%)\s*,\s*(\d{1,3}\%)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
                    b.Color.reHex = /^#?([0-9a-f]{6}|[0-9a-f]{3})$/i,
                    b.Color.colorNameMap = {
                        aqua: "#00FFFF",
                        black: "#000000",
                        blue: "#0000FF",
                        fuchsia: "#FF00FF",
                    ...
                    ,
                    b.Color.fromHsla = c.fromHsl,
                    b.Color.fromHex = function (a) {
            ...
            function () {
                function a(a) {
                    ...
                    if (c = parseFloat(c) / (/%$/.test(c) ? 100 : 1),
                            c = c < 0 ? 0 : c > 1 ? 1 : c,
                            b) {
                        var g = b.split(/\s*;\s*/);
                        "" === g[g.length - 1] && g.pop();
                    ...
                    return d || (d = a.getAttribute("stop-color") || "rgb(0,0,0)"),
                    f || (f = a.getAttribute("stop-opacity")),
                        d = new fabric.Color(d),
                        e = d.getAlpha(),
                        f = isNaN(parseFloat(f)) ? 1 : parseFloat(f),
                        f *= e,
                        {
                            offset: c,
                            color: d.toRgb(),
                ...
                fabric.Gradient = fabric.util.createClass({
                    ...
                    initialize: function (a) {
                        ...
                        "radial" === this.type && (b.r1 = a.coords.r1 || 0,
                            b.r2 = a.coords.r2 || 0),
                            this.coords = b,
                            this.colorStops = a.colorStops.slice(),
                        a.gradientTransform && (this.gradientTransform = a.gradientTransform),
                    ...
                    toSVG: function (a) {
                        ...
                        if (this.colorStops.sort(function (a, b) {
                            ...
                            !a.group || "path-group" !== a.group.type)
                            for (var e in b)
                                "x1" === e || "x2" === e || "r2" === e ? b[e] += this.offsetX - a.width / 2 : "y1" !== e && "y2" !== e || (b[e] += this.offsetY - a.height / 2);
                        ...
                        this.gradientTransform && (d += ' gradientTransform="matrix(' + this.gradientTransform.join(" ") + ')" '),
                            "linear" === this.type ? c = ["<linearGradient ", d, ' x1="', b.x1, '" y1="', b.y1, '" x2="', b.x2, '" y2="', b.y2, '">\n'] : "radial" === this.type && (c = ["<radialGradient ", d, ' cx="', b.x2, '" cy="', b.y2, '" r="', b.r2, '" fx="', b.x1, '" fy="', b.y1, '">\n']);
                        for (var f = 0; f < this.colorStops.length; f++)
                            c.push("<stop ", 'offset="', 100 * this.colorStops[f].offset + "%", '" style="stop-color:', this.colorStops[f].color, null != this.colorStops[f].opacity ? ";stop-opacity: " + this.colorStops[f].opacity : ";", '"/>\n');
                    ...
                    toLive: function (a) {
                        ...
                        if (this.type) {
                            ...
                            for (var c = 0, d = this.colorStops.length; c < d; c++) {
                                ...
                                "undefined" != typeof f && (e = new fabric.Color(e).setAlpha(f).toRgba()),
                    ...
                    fabric.util.object.extend(fabric.Gradient, {
                        fromElement: function (e, f) {
                            var m, g = e.getElementsByTagName("stop"),
                                h = "linearGradient" === e.nodeName ? "linear" : "radial",
                                i = e.getAttribute("gradientUnits") || "objectBoundingBox",
                                j = e.getAttribute("gradientTransform"), k = [], l = {};
                            ...
                            return (j || "" !== m) && (o.gradientTransform = fabric.parseTransformAttribute((j || "") + m)),
                                o
                        },
                        forObject: function (a, b) {
                            return b || (b = {}),
                                d(a, b.coords, "userSpaceOnUse"),
                                new fabric.Gradient(b)
                        }
                    })
            }(),
            fabric.Pattern = fabric.util.createClass({
                ...
                toSVG: function (a) {
                    var b = "function" == typeof this.source ? this.source() : this.source
                        ...
                        , e = "";
                    return b.src ? e = b.src : b.toDataURL && (e = b.toDataURL()),
                    '<pattern id="SVGID_' + this.id + '" x="' + this.offsetX + '" y="' + this.offsetY + '" width="' + c + '" height="' + d + '"><image x="0" y="0" width="' + b.width + '" height="' + b.height + '" xlink:href="' + e + '"></image></pattern>'
                },
                toLive: function (a) {
                    var b = "function" == typeof this.source ? this.source() : this.source;
                    if (!b)
                    ...
                    if ("undefined" != typeof b.src) {
                        if (!b.complete)
                            return "";
                        if (0 === b.naturalWidth || 0 === b.naturalHeight)
                            return ""
                    }
            ...
            function (a) {
                ...
                return b.Shadow ? void b.warn("fabric.Shadow is already defined.") : (b.Shadow = b.util.createClass({
                    ...
                    toSVG: function (a) {
                        var b = "SourceAlpha";
                        return !a || a.fill !== this.color && a.stroke !== this.color || (b = "SourceGraphic"),
                        '<filter id="SVGID_' + this.id + '" y="-40%" height="180%"><feGaussianBlur in="' + b + '" stdDeviation="' + (this.blur ? this.blur / 3 : 0) + '"></feGaussianBlur><feOffset dx="' + this.offsetX + '" dy="' + this.offsetY + '"></feOffset><feMerge><feMergeNode></feMergeNode><feMergeNode in="SourceGraphic"></feMergeNode></feMerge></filter>'
                    },
                    toObject: function () {
                        ...
                        return this.color !== c.color && (a.color = this.color),
            ...
            function () {
                ...
                fabric.StaticCanvas = fabric.util.createClass({
                    ...
                    _initStatic: function (a, b) {
                        ...
                        b.overlayImage && this.setOverlayImage(b.overlayImage, this.renderAll.bind(this)),
                        b.backgroundImage && this.setBackgroundImage(b.backgroundImage, this.renderAll.bind(this)),
                        b.backgroundColor && this.setBackgroundColor(b.backgroundColor, this.renderAll.bind(this)),
                        b.overlayColor && this.setOverlayColor(b.overlayColor, this.renderAll.bind(this)),
                            this.calcOffset()
                    },
                    calcOffset: function () {
                        return this._offset = b(this.lowerCanvasEl),
                            this
                    },
                    ...
                    _setImageSmoothing: function () {
                        ...
                        a.imageSmoothingEnabled = this.imageSmoothingEnabled,
                            a.webkitImageSmoothingEnabled = this.imageSmoothingEnabled,
                            a.mozImageSmoothingEnabled = this.imageSmoothingEnabled,
                            a.msImageSmoothingEnabled = this.imageSmoothingEnabled,
                            a.oImageSmoothingEnabled = this.imageSmoothingEnabled
                    },
                    __setBgOverlayImage: function (a, b, c, d) {
                        return "string" == typeof b ? fabric.util.loadImage(b, function (b) {
                            this[a] = new fabric.Image(b, d),
                            c && c()
                        }, this) : (this[a] = b,
                        c && c()),
                            this
                    ...
                    _createCanvasElement: function () {
                        ...
                        if (a.style || (a.style = {}),
                                !a)
                            throw d;
                        return this._initCanvasElement(a),
                            a
                    },
                    _initCanvasElement: function (a) {
                        if (fabric.util.createCanvasElement(a),
                    ...
                    _createLowerCanvas: function (a) {
                        this.lowerCanvasEl = fabric.util.getById(a) || this._createCanvasElement(),
                    ...
                    setDimensions: function (a, b) {
                        ...
                        return b.cssOnly || this.renderAll(),
                            this.calcOffset(),
                            this
                    },
                    ...
                    setViewportTransform: function (a) {
                        ...
                        for (var b = 0, c = this._objects.length; b < c; b++)
                            this._objects[b].setCoords();
                        return this
                    },
                    zoomToPoint: function (a, b) {
                        var c = a;
                        a = fabric.util.transformPoint(a, fabric.util.invertTransform(this.viewportTransform)),
                            this.viewportTransform[0] = b,
                            this.viewportTransform[3] = b;
                        var d = fabric.util.transformPoint(a, this.viewportTransform);
                        this.viewportTransform[4] += c.x - d.x,
                            this.viewportTransform[5] += c.y - d.y,
                            this.renderAll();
                        for (var e = 0, f = this._objects.length; e < f; e++)
                            this._objects[e].setCoords();
                        return this
                    },
                    setZoom: function (a) {
                        return this.zoomToPoint(new fabric.Point(0, 0), a),
                            this
                    },
                    absolutePan: function (a) {
                        this.viewportTransform[4] = -a.x,
                            this.viewportTransform[5] = -a.y,
                            this.renderAll();
                        for (var b = 0, c = this._objects.length; b < c; b++)
                            this._objects[b].setCoords();
                        return this
                    ...
                    _draw: function (a, b) {
                        if (b) {
                            ...
                            a.transform(c[0], c[1], c[2], c[3], c[4], c[5]),
                                b.render(a),
                                a.restore(),
                            this.controlsAboveOverlay || b._renderControls(a)
                        }
                    },
                    ...
                    _renderObjects: function (a, b) {
                        ...
                        if (b)
                            for (c = 0,
                                     d = this._objects.length; c < d; ++c)
                                this._objects[c] && !b.contains(this._objects[c]) && this._draw(a, this._objects[c]);
                        else
                            for (c = 0,
                                     d = this._objects.length; c < d; ++c)
                                this._draw(a, this._objects[c])
                    },
                    ...
                    _renderBackground: function (a) {
                        this.backgroundColor && (a.fillStyle = this.backgroundColor.toLive ? this.backgroundColor.toLive(a) : this.backgroundColor,
                            a.fillRect(this.backgroundColor.offsetX || 0, this.backgroundColor.offsetY || 0, this.width, this.height)),
                        this.backgroundImage && this._draw(a, this.backgroundImage)
                    },
                    _renderOverlay: function (a) {
                        this.overlayColor && (a.fillStyle = this.overlayColor.toLive ? this.overlayColor.toLive(a) : this.overlayColor,
                            a.fillRect(this.overlayColor.offsetX || 0, this.overlayColor.offsetY || 0, this.width, this.height)),
                        this.overlayImage && this._draw(a, this.overlayImage)
                    },
                    renderTop: function () {
                    ...
                    centerObjectH: function (a) {
                        return this._centerObject(a, new fabric.Point(this.getCenter().left, a.getCenterPoint().y)),
                            this.renderAll(),
                            this
                    },
                    centerObjectV: function (a) {
                        return this._centerObject(a, new fabric.Point(a.getCenterPoint().x, this.getCenter().top)),
                            this.renderAll(),
                            this
                    },
                    centerObject: function (a) {
                        var b = this.getCenter();
                        return this._centerObject(a, new fabric.Point(b.left, b.top)),
                            this.renderAll(),
                            this
                    },
                    ...
                    _toObjectMethod: function (b, c) {
                        ...
                        return a(e, this.__serializeBgOverlay()),
                            fabric.util.populateWithProperties(this, e, c),
                        d && (this.setActiveGroup(new fabric.Group(d.getObjects(), {
                            originX: "center",
                            originY: "center"
                        })),
                    ...
                    __serializeBgOverlay: function () {
                        ...
                        return this.overlayColor && (a.overlay = this.overlayColor.toObject ? this.overlayColor.toObject() : this.overlayColor),
                        this.backgroundImage && (a.backgroundImage = this.backgroundImage.toObject()),
                        this.overlayImage && (a.overlayImage = this.overlayImage.toObject()),
                            a
                    },
                    ...
                    toSVG: function (a, b) {
                        ...
                        return this._setSVGPreamble(c, a),
                            ...
                            this._setSVGBgOverlayImage(c, "backgroundImage"),
                            this._setSVGObjects(c, b),
                            this._setSVGBgOverlayColor(c, "overlayColor"),
                            this._setSVGBgOverlayImage(c, "overlayImage"),
                            c.push("</svg>"),
                            c.join("")
                    },
                        ...
                        supports: function (a) {
                            ...
                            switch (a) {
                                ...
                                case "toDataURLWithQuality":
                                    try {
                                        return b.toDataURL("image/jpeg", 0),
                                            !0
                                    } catch (a) {
                                    }
                                    return !1;
            ...
            fabric.BaseBrush = fabric.util.createClass({
                ...
                setShadow: function (a) {
                    return this.shadow = new fabric.Shadow(a),
                        this
                },
                ...
                fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
                    ...
                    _render: function () {
                        ...
                        a.save(),
                            ...
                            a.beginPath(),
                        2 === this._points.length && c.x === d.x && c.y === d.y && (c.x -= .5,
                            d.x += .5),
                            a.moveTo(c.x, c.y);
                        for (var e = 1, f = this._points.length; e < f; e++) {
                            var g = c.midPointFrom(d);
                            a.quadraticCurveTo(c.x, c.y, g.x, g.y),
                                c = this._points[e],
                                d = this._points[e + 1]
                        }
                        a.lineTo(c.x, c.y),
                    ...
                    convertPointsToSVGPath: function (a, b, c) {
                        var d = []
                            , e = new fabric.Point(a[0].x - b, a[0].y - c)
                            , f = new fabric.Point(a[1].x - b, a[1].y - c);
                        d.push("M ", a[0].x - b, " ", a[0].y - c, " ");
                        for (var g = 1, h = a.length; g < h; g++) {
                            var i = e.midPointFrom(f);
                            d.push("Q ", e.x, " ", e.y, " ", i.x, " ", i.y, " "),
                                e = new fabric.Point(a[g].x - b, a[g].y - c),
                            g + 1 < a.length && (f = new fabric.Point(a[g + 1].x - b, a[g + 1].y - c))
                        }
                        return d.push("L ", e.x, " ", e.y, " "),
                            d
                    },
            ...
            fabric.SprayBrush = fabric.util.createClass(fabric.BaseBrush, {
                ...
                onMouseUp: function () {
                    var a = this.canvas.renderOnAddRemove;
                    this.canvas.renderOnAddRemove = !1;
                    for (var b = [], c = 0, d = this.sprayChunks.length; c < d; c++)
                        for (var e = this.sprayChunks[c], f = 0, g = e.length; f < g; f++) {
                ...
                _getOptimizedRects: function (a) {
                    for (var c, b = {}, d = 0, e = a.length; d < e; d++)
                        c = a[d].left + "" + a[d].top,
                        b[c] || (b[c] = a[d]);
                    var f = [];
                    for (c in b)
                ...
                render: function () {
                    ...
                    for (var c = 0, d = this.sprayChunkPoints.length; c < d; c++) {
                        ...
                        "undefined" != typeof e.opacity && (a.globalAlpha = e.opacity),
                            a.fillRect(e.x, e.y, e.width, e.width)
                    }
                    a.restore()
                },
                addSprayChunk: function (a) {
                    ...
                    for (var b, c, d, e = this.width / 2, f = 0; f < this.density; f++) {
                        b = fabric.util.getRandomInt(a.x - e, a.x + e),
                            ...
                            d = this.dotWidthVariance ? fabric.util.getRandomInt(Math.max(1, this.dotWidth - this.dotWidthVariance), this.dotWidth + this.dotWidthVariance) : this.dotWidth;
                        var g = new fabric.Point(b, c);
                        g.width = d,
                        this.randomOpacity && (g.opacity = fabric.util.getRandomInt(0, 100) / 100),
            ...
            fabric.util.object.extend(fabric.StaticCanvas.prototype, {
                ...
                __getCroppedCanvas: function (a, b) {
                    ...
                    return e && (c = fabric.util.createCanvasElement(),
                        d = c.getContext("2d"),
                ...
                __toDataURLWithMultiplier: function (a, b, c, d) {
                    ...
                    d > 1 && this.setWidth(g).setHeight(h),
                        k.scale(d, d),
                    c.left && (c.left *= d),
                    c.top && (c.top *= d),
                        c.width ? c.width *= d : d < 1 && (c.width = g),
                        c.height ? c.height *= d : d < 1 && (c.height = h),
                        j ? this._tempRemoveBordersControlsFromGroup(j) : i && this.deactivateAll && this.deactivateAll(),
                        this.renderAll(!0);
                    ...
                    return this.width = e,
                        ...
                        j ? this._restoreBordersControlsOnGroup(j) : i && this.setActiveObject && this.setActiveObject(i),
                    this.contextTop && this.clearContext(this.contextTop),
                        this.renderAll(),
                        l
                },
            ...
            fabric.util.object.extend(fabric.StaticCanvas.prototype, {
                ...
                _setBgOverlay: function (a, b) {
                    ...
                    if (!(a.backgroundImage || a.overlayImage || a.background || a.overlay))
                        return void (b && b());
                    var e = function () {
                        d.backgroundImage && d.overlayImage && d.backgroundColor && d.overlayColor && (c.renderAll(),
                        b && b())
                    };
                    this.__setBgOverlay("backgroundImage", a.backgroundImage, d, e),
                        this.__setBgOverlay("overlayImage", a.overlayImage, d, e),
                        this.__setBgOverlay("backgroundColor", a.background, d, e),
                        this.__setBgOverlay("overlayColor", a.overlay, d, e),
                        e()
                },
                ...
                _enlivenObjects: function (a, b, c) {
                    ...
                    this.renderOnAddRemove = !1,
                        fabric.util.enlivenObjects(a, function (a) {
                            a.forEach(function (a, b) {
                                d.insertAt(a, b, !0)
                            }),
                ...
                cloneWithoutData: function (a) {
                    ...
                    c.clipTo = this.clipTo,
                        this.backgroundImage ? (c.setBackgroundImage(this.backgroundImage.src, function () {
                            ...
                            c.backgroundImageStretch = this.backgroundImageStretch) : a && a(c)
                }
            }),
            function (a) {
                "use strict";
                ...
                b.Object || (b.Object = b.util.createClass({
                    ...
                    _initClipping: function (a) {
                        if (a.clipTo && "string" == typeof a.clipTo) {
                            ...
                            "undefined" != typeof c && (this.clipTo = undefined)
                    ...
                    transform: function (a, b) {
                        this.group && this.group.transform(a, b),
                    ...
                    toObject: function (a) {
                        ...
                        return this.includeDefaultValues || (e = this._removeDefaultValues(e)),
                    ...
                    _set: function (a, c) {
                        ...
                        return e && (c = this._constrainScale(c)),
                            "scaleX" === a && c < 0 ? (this.flipX = !this.flipX,
                                c *= -1) : "scaleY" === a && c < 0 ? (this.flipY = !this.flipY,
                                c *= -1) : "width" === a || "height" === a ? this.minScaleLimit = d(Math.min(.1, 1 / Math.max(this.width, this.height)), 2) : "shadow" !== a || !c || c instanceof b.Shadow || (c = new b.Shadow(c)),
                            this[a] = c,
                            this
                    },
                    toggle: function (a) {
                    ...
                    _setStrokeStyles: function (a) {
                        this.stroke && (a.lineWidth = this.strokeWidth,
                            ...
                            a.strokeStyle = this.stroke.toLive ? this.stroke.toLive(a) : this.stroke)
                    },
                    ...
                    _renderControls: function (a, c) {
                        ...
                        if (a.save(),
                            this.active && !c) {
                            var e;
                            this.group && (e = b.util.transformPoint(this.group.getCenterPoint(), d),
                                a.translate(e.x, e.y),
                                a.rotate(f(this.group.angle))),
                                e = b.util.transformPoint(this.getCenterPoint(), d, null != this.group),
                            this.group && (e.x *= this.group.scaleX,
                                e.y *= this.group.scaleY),
                                a.translate(e.x, e.y),
                                a.rotate(f(this.angle)),
                                this.drawBorders(a),
                                this.drawControls(a)
                    ...
                    _setShadow: function (a) {
                        this.shadow && (a.shadowColor = this.shadow.color,
                            a.shadowBlur = this.shadow.blur,
                            a.shadowOffsetX = this.shadow.offsetX,
                            a.shadowOffsetY = this.shadow.offsetY)
                    },
                    ...
                    _renderFill: function (a) {
                        if (this.fill) {
                            if (a.save(),
                                this.fill.toLive && a.translate(-this.width / 2 + this.fill.offsetX || 0, -this.height / 2 + this.fill.offsetY || 0),
                                    this.fill.gradientTransform) {
                                var b = this.fill.gradientTransform;
                                a.transform.apply(a, b)
                            }
                            "destination-over" === this.fillRule ? a.fill("evenodd") : a.fill(),
                                a.restore(),
                        ...
                        if (this.stroke && 0 !== this.strokeWidth) {
                            if (a.save(),
                                ...
                                1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray),
                                    g ? (a.setLineDash(this.strokeDashArray),
                                    this._stroke && this._stroke(a)) : this._renderDashedStroke && this._renderDashedStroke(a),
                                    a.stroke();
                            else {
                    ...
                    _setupFillRule: function (a) {
                        this.fillRule && (this._prevFillRule = a.globalCompositeOperation,
                            a.globalCompositeOperation = this.fillRule)
                    },
            ...
            function () {
                ...
                fabric.util.object.extend(fabric.Object.prototype, {
                    translateToCenterPoint: function (b, c, d) {
                        var e = b.x
                            , f = b.y
                            , g = this.stroke ? this.strokeWidth : 0;
                        return "left" === c ? e = b.x + (this.getWidth() + g * this.scaleX) / 2 : "right" === c && (e = b.x - (this.getWidth() + g * this.scaleX) / 2),
                            "top" === d ? f = b.y + (this.getHeight() + g * this.scaleY) / 2 : "bottom" === d && (f = b.y - (this.getHeight() + g * this.scaleY) / 2),
                    ...
                    toLocalPoint: function (b, c, d) {
                        ...
                        return c && d ? (g = "left" === c ? e.x - (this.getWidth() + f * this.scaleX) / 2 : "right" === c ? e.x + (this.getWidth() + f * this.scaleX) / 2 : e.x,
                            h = "top" === d ? e.y - (this.getHeight() + f * this.scaleY) / 2 : "bottom" === d ? e.y + (this.getHeight() + f * this.scaleY) / 2 : e.y) : (g = this.left,
                            h = this.top),
                            fabric.util.rotatePoint(new fabric.Point(b.x, b.y), e, -a(this.angle)).subtractEquals(new fabric.Point(g, h))
                    },
                    ...
                    adjustPosition: function (b) {
                        var c = a(this.angle)
                            ...
                            , h = Math.cos(c) * g
                            , i = Math.sin(c) * g;
                        "center" === this.originX && "left" === b || "right" === this.originX && "center" === b ? (this.left -= e,
                            this.top -= f) : "left" === this.originX && "center" === b || "center" === this.originX && "right" === b ? (this.left += e,
                            this.top += f) : "left" === this.originX && "right" === b ? (this.left += h,
                            this.top += i) : "right" === this.originX && "left" === b && (this.left -= h,
                                this.top -= i),
                            this.setCoords(),
                            this.originX = b
                    },
            ...
            function () {
                ...
                fabric.util.object.extend(fabric.Object.prototype, {
                    ...
                    _findCrossPoints: function (a, b) {
                        ...
                        for (var k in b)
                            if (j = b[k],
                                    !(j.o.y < a.y && j.d.y < a.y || j.o.y >= a.y && j.d.y >= a.y || (j.o.x === j.d.x && j.o.x >= a.x ? (g = j.o.x,
                                        h = a.y) : (c = 0,
                                        d = (j.d.y - j.o.y) / (j.d.x - j.o.x),
                                        e = a.y - c * a.x,
                                        f = j.o.y - d * j.o.x,
                                        g = -(e - f) / (c - d),
                                        h = e + c * g),
                    ...
                    setCoords: function () {
                        var b = this.strokeWidth > 1 ? this.strokeWidth : 0
                            ...
                            , i = "line" === this.type && 1 === this.width
                            , j = "line" === this.type && 1 === this.height
                            , k = h && j || "line" !== this.type
                            , l = h && i || "line" !== this.type;
                        i ? f = b : j && (g = b),
                        k && (f += b),
                        l && (g += b),
                            this.currentWidth = f * this.scaleX,
                            this.currentHeight = g * this.scaleY,
                        ...
                        var m = Math.sqrt(Math.pow(this.currentWidth / 2, 2) + Math.pow(this.currentHeight / 2, 2))
                            ...
                            , t = new fabric.Point(this.currentWidth, this.currentHeight)
                            , u = new fabric.Point(s.x - o, s.y - p)
                            , v = new fabric.Point(u.x + t.x * r, u.y + t.x * q)
                            , w = new fabric.Point(u.x - t.y * q, u.y + t.y * r)
                            , x = new fabric.Point(u.x + t.x / 2 * r, u.y + t.x / 2 * q)
                            , y = e(u)
                            , z = e(v)
                            , A = e(new fabric.Point(v.x - t.y * q, v.y + t.y * r))
                            , B = e(w)
                            , C = e(new fabric.Point(u.x - t.y / 2 * q, u.y + t.y / 2 * r))
                            , D = e(x)
                            , E = e(new fabric.Point(v.x - t.y / 2 * q, v.y + t.y / 2 * r))
                            , F = e(new fabric.Point(w.x + t.x / 2 * r, w.y + t.x / 2 * q))
                            , G = e(new fabric.Point(x.x, x.y))
                            , H = Math.cos(n + c) * this.padding * Math.sqrt(2)
                            , I = Math.sin(n + c) * this.padding * Math.sqrt(2);
                        return y = y.add(new fabric.Point(-H, -I)),
                            z = z.add(new fabric.Point(I, -H)),
                            A = A.add(new fabric.Point(H, I)),
                            B = B.add(new fabric.Point(-I, H)),
                            C = C.add(new fabric.Point((-H - I) / 2, (-I + H) / 2)),
                            D = D.add(new fabric.Point((I - H) / 2, -(I + H) / 2)),
                            E = E.add(new fabric.Point((I + H) / 2, (I - H) / 2)),
                            F = F.add(new fabric.Point((H - I) / 2, (H + I) / 2)),
                            G = G.add(new fabric.Point((I - H) / 2, -(I + H) / 2)),
                            this.oCoords = {
                                tl: y,
                                tr: z,
                                br: A,
            ...
            fabric.util.object.extend(fabric.Object.prototype, {
                ...
                sendBackwards: function (a) {
                    return this.group ? fabric.StaticCanvas.prototype.sendBackwards.call(this.group, this, a) : this.canvas.sendBackwards(this, a),
                        this
                },
                bringForward: function (a) {
                    return this.group ? fabric.StaticCanvas.prototype.bringForward.call(this.group, this, a) : this.canvas.bringForward(this, a),
                        this
                },
                moveTo: function (a) {
                    return this.group ? fabric.StaticCanvas.prototype.moveTo.call(this.group, this, a) : this.canvas.moveTo(this, a),
                        this
                }
            }),
            fabric.util.object.extend(fabric.Object.prototype, {
            ...
            fabric.util.object.extend(fabric.Object.prototype, {
                ...
                saveState: function (a) {
                    ...
                    a && a.stateProperties && a.stateProperties.forEach(function (a) {
                        this.originalState[a] = this.get(a)
                    }, this),
                        this
                },
            ...
            function (a) {
                ...
                return b.Line ? void b.warn("fabric.Line is already defined") : (b.Line = b.util.createClass(b.Object, {
                    ...
                    _set: function (a, b) {
                        return this[a] = b,
                        "undefined" != typeof d[a] && this._setWidthHeight(),
                            this
                    },
                    _getLeftToOriginX: f({
                        origin: "originX",
                    ...
                    _render: function (a, b) {
                        ...
                        if (!this.strokeDashArray || this.strokeDashArray && e) {
                            var d = this.x1 <= this.x2 ? -1 : 1
                                , f = this.y1 <= this.y2 ? -1 : 1;
                            a.moveTo(1 === this.width ? 0 : d * this.width / 2, 1 === this.height ? 0 : f * this.height / 2),
                                a.lineTo(1 === this.width ? 0 : d * -1 * this.width / 2, 1 === this.height ? 0 : f * -1 * this.height / 2)
                        }
                ...
                return b.Circle ? void b.warn("fabric.Circle is already defined.") : (b.Circle = b.util.createClass(b.Object, {
                    ...
                    toSVG: function (a) {
                        var b = this._createBaseSVGMarkup()
                            , c = 0
                            , d = 0;
                        return this.group && (c = this.left + this.radius,
                            d = this.top + this.radius),
                            b.push("<circle ", 'cx="' + c + '" cy="' + d + '" ', 'r="', this.radius, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), " ", this.getSvgTransformMatrix(), '"/>\n'),
                            a ? a(b.join("")) : b.join("")
                    },
                    _render: function (a, b) {
                        a.beginPath(),
                            a.arc(b ? this.left + this.radius : 0, b ? this.top + this.radius : 0, this.radius, 0, c, !1),
                            this._renderFill(a),
                    ...
                    b.Circle.ATTRIBUTE_NAMES = b.SHARED_ATTRIBUTES.concat("cx cy r".split(" ")),
                    b.Circle.fromElement = function (a, c) {
                        c || (c = {});
                ...
                return b.Triangle ? void b.warn("fabric.Triangle is already defined") : (b.Triangle = b.util.createClass(b.Object, {
                    ...
                    toSVG: function (a) {
                        var b = this._createBaseSVGMarkup()
                            ...
                            , d = this.height / 2
                            , e = [-c + " " + d, "0 " + -d, c + " " + d].join(",");
                        return b.push("<polygon ", 'points="', e, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), '"/>'),
                            a ? a(b.join("")) : b.join("")
                    },
                    complexity: function () {
                        return 1
                ...
                return b.Ellipse ? void b.warn("fabric.Ellipse is already defined.") : (b.Ellipse = b.util.createClass(b.Object, {
                    ...
                    toSVG: function (a) {
                        var b = this._createBaseSVGMarkup()
                            , c = 0
                            , d = 0;
                        return this.group && (c = this.left + this.rx,
                            d = this.top + this.ry),
                            b.push("<ellipse ", 'cx="', c, '" cy="', d, '" ', 'rx="', this.rx, '" ry="', this.ry, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), this.getSvgTransformMatrix(), '"/>\n'),
                            a ? a(b.join("")) : b.join("")
                    },
                    _render: function (a, b) {
                        a.beginPath(),
            ...
            function (a) {
                ...
                d.push("rx", "ry", "x", "y"),
                    b.Rect = b.util.createClass(b.Object, {
                        ...
                        _render: function (a, b) {
                            if (1 === this.width && 1 === this.height)
                                return void a.fillRect(0, 0, 1, 1);
                        ...
                        toSVG: function (a) {
                            var b = this._createBaseSVGMarkup()
                                , c = this.left
                                , d = this.top;
                            return this.group || (c = -this.width / 2,
                                d = -this.height / 2),
                                b.push("<rect ", 'x="', c, '" y="', d, '" rx="', this.get("rx"), '" ry="', this.get("ry"), '" width="', this.width, '" height="', this.height, '" style="', this.getSvgStyles(), '" transform="', this.getSvgTransform(), this.getSvgTransformMatrix(), '"/>\n'),
                                a ? a(b.join("")) : b.join("")
                        },
                        complexity: function () {
                            return 1
                    ...
                    b.Rect.fromElement = function (a, d) {
                        ...
                        return e.left = e.left || 0,
                            e.top = e.top || 0,
                            new b.Rect(c(d ? b.util.object.clone(d) : {}, e))
                    }
                    ,
            ...
            function (a) {
                ...
                return b.Polyline ? void b.warn("fabric.Polyline is already defined") : (b.Polyline = b.util.createClass(b.Object, {
                    ...
                    toSVG: function (a) {
                        for (var b = [], d = this._createBaseSVGMarkup(), e = 0, f = this.points.length; e < f; e++)
                            b.push(c(this.points[e].x, 2), ",", c(this.points[e].y, 2), " ");
                    ...
                    _render: function (a) {
                        var b;
                        a.beginPath(),
                        this._applyPointOffset && (this.group && "path-group" === this.group.type || this._applyPointOffset(),
                            this._applyPointOffset = null),
                            a.moveTo(this.points[0].x, this.points[0].y);
                        for (var c = 0, d = this.points.length; c < d; c++)
                            b = this.points[c],
                                a.lineTo(b.x, b.y);
                        this._renderFill(a),
                            this._renderStroke(a)
                ...
                return b.Polygon ? void b.warn("fabric.Polygon is already defined") : (b.Polygon = b.util.createClass(b.Object, {
                    ...
                    _applyPointOffset: function () {
                        this.points.forEach(function (a) {
                            a.x -= this.left + this.width / 2,
                                a.y -= this.top + this.height / 2
                        }, this)
                    },
                    toObject: function (a) {
                        return c(this.callSuper("toObject", a), {
                    ...
                    toSVG: function (a) {
                        for (var b = [], c = this._createBaseSVGMarkup(), d = 0, e = this.points.length; d < e; d++)
                            b.push(f(this.points[d].x, 2), ",", f(this.points[d].y, 2), " ");
                    ...
                    _render: function (a) {
                        ...
                        for (var c = 0, d = this.points.length; c < d; c++)
                            b = this.points[c],
                                a.lineTo(b.x, b.y);
                        this._renderFill(a),
                        (this.stroke || this.strokeDashArray) && (a.closePath(),
                            this._renderStroke(a))
                    },
                    _renderDashedStroke: function (a) {
                        var c, d;
                ...
                return b.Path ? void b.warn("fabric.Path is already defined") : (b.Path = b.util.createClass(b.Object, {
                    ...
                    _initializePath: function (a) {
                        var b = "width" in a && null != a.width
                            ...
                            , g = d ? this.left : 0
                            , h = f ? this.top : 0;
                        b && c ? (f || (this.top = this.height / 2),
                        d || (this.left = this.width / 2)) : (e(this, this._parseDimensions()),
                        b && (this.width = a.width),
                        c && (this.height = a.height)),
                            this.pathOffset = this.pathOffset || this._calculatePathOffset(g, h)
                    },
                            ...
                            switch (c = this.path[r],
                                ...
                                case "c":
                                    l = h + c[5],
                                        ...
                                        j = h + c[3],
                                        k = i + c[4],
                                        a.bezierCurveTo(h + c[1] + p, i + c[2] + q, j + p, k + q, l + p, m + q),
                                        h = l,
                                        i = m;
                                    break;
                                case "C":
                                    h = c[5],
                                        ...
                                        j = c[3],
                                        k = c[4],
                                        a.bezierCurveTo(c[1] + p, c[2] + q, j + p, k + q, h + p, i + q);
                                    break;
                                case "s":
                                    l = h + c[3],
                                        m = i + c[4],
                                        j = j ? 2 * h - j : h,
                                        k = k ? 2 * i - k : i,
                                        a.bezierCurveTo(j + p, k + q, h + c[1] + p, i + c[2] + q, l + p, m + q),
                                        j = h + c[1],
                                        k = i + c[2],
                                        h = l,
                                        i = m;
                                ...
                                case "S":
                                    l = c[3],
                                        ...
                                        j = 2 * h - j,
                                        k = 2 * i - k,
                                        a.bezierCurveTo(j + p, k + q, c[1] + p, c[2] + q, l + p, m + q),
                                        h = l,
                                        i = m,
                                        j = c[1],
                                        k = c[2];
                                ...
                                case "q":
                                    l = h + c[3],
                                        ...
                                        j = h + c[1],
                                        k = i + c[2],
                                        a.quadraticCurveTo(j + p, k + q, l + p, m + q),
                                        h = l,
                                        i = m;
                                    break;
                                case "Q":
                                    l = c[3],
                                        m = c[4],
                                        a.quadraticCurveTo(c[1] + p, c[2] + q, l + p, m + q),
                                        h = l,
                                        i = m,
                                        j = c[1],
                                        k = c[2];
                                ...
                                case "t":
                                    l = h + c[1],
                                        m = i + c[2],
                                        null === d[0].match(/[QqTt]/) ? (j = h,
                                            k = i) : "t" === d[0] ? (j = 2 * h - n,
                                            k = 2 * i - o) : "q" === d[0] && (j = 2 * h - j,
                                                k = 2 * i - k),
                                        n = j,
                                        o = k,
                                        a.quadraticCurveTo(j + p, k + q, l + p, m + q),
                                ...
                                case "T":
                                    ...
                                    break;
                                case "a":
                                    g(a, h + p, i + q, [c[1], c[2], c[3], c[4], c[5], c[6] + h + p, c[7] + i + q]),
                                        h += c[6],
                                        i += c[7];
                                    break;
                                case "A":
                                    g(a, h + p, i + q, [c[1], c[2], c[3], c[4], c[5], c[6] + p, c[7] + q]),
                                        h = c[6],
                                        i = c[7];
                                    break;
                                case "z":
                    ...
                    render: function (a, c) {
                        if (this.visible) {
                            a.save(),
                            c && a.translate(-this.width / 2, -this.height / 2);
                            var d = this.transformMatrix;
                            d && a.transform(d[0], d[1], d[2], d[3], d[4], d[5]),
                            c || this.transform(a),
                                this._setStrokeStyles(a),
                                this._setFillStyles(a),
                                this._setShadow(a),
                    ...
                    toObject: function (a) {
                        ...
                        return this.sourcePath && (b.sourcePath = this.sourcePath),
                        this.transformMatrix && (b.transformMatrix = this.transformMatrix),
                            b
                    },
                    toDatalessObject: function (a) {
                    ...
                    toSVG: function (a) {
                        for (var b = [], c = this._createBaseSVGMarkup(), d = 0, e = this.path.length; d < e; d++)
                            b.push(this.path[d].join(" "));
                        var f = b.join(" ");
                    ...
                    _parsePath: function () {
                        for (var c, d, f, g, k, a = [], b = [],
                                 e = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi, j = 0,
                                 l = this.path.length; j < l; j++) {
                            for (c = this.path[j],
                                     g = c.slice(1).trim(),
                                     b.length = 0; f = e.exec(g);)
                                b.push(f[0]);
                            k = [c.charAt(0)];
                            ...
                            var o = k[0]
                                ...
                                , q = i[o] || o;
                            if (k.length - 1 > p)
                                for (var r = 1, s = k.length; r < s; r += p)
                                    a.push([o].concat(k.slice(r, r + p))),
                                        o = q;
                            else
                                a.push(k)
                        }
                    ...
                    _getCoordsFromCommand: function (a, b, c, d, e) {
                        ...
                        "V" !== a[0] && (e.y = k(0 === b ? a : this.path[b - 1])),
                        a[0] === a[0].toLowerCase() && (f = !0);
                    ...
                    _getXY: function (a, b, c) {
                        var d = b ? c.x + j(a) : "V" === a[0] ? c.x : j(a)
                            , e = b ? c.y + k(a) : "H" === a[0] ? c.y : k(a);
                        return {
                            x: d,
                            y: e
                        }
            ...
            function (a) {
                ...
                return b.PathGroup ? void b.warn("fabric.PathGroup is already defined") : (b.PathGroup = b.util.createClass(b.Path, {
                    ...
                    initialize: function (a, b) {
                        ...
                        this.setOptions(b),
                        b.widthAttr && (this.scaleX = b.widthAttr / b.width),
                        b.heightAttr && (this.scaleY = b.heightAttr / b.height),
                            this.setCoords(),
                        b.sourcePath && this.setSourcePath(b.sourcePath)
                    },
                    render: function (a) {
                        if (this.visible) {
                            ...
                            c && a.transform(c[0], c[1], c[2], c[3], c[4], c[5]),
                                ...
                                this._setShadow(a),
                            this.clipTo && b.util.clipContext(this, a);
                            for (var d = 0, e = this.paths.length; d < e; ++d)
                    ...
                    toSVG: function (a) {
                        for (var b = this.getObjects(), c = "translate(" + this.left + " " + this.top + ")",
                                 d = ["<g ", 'style="', this.getSvgStyles(), '" ', 'transform="', c, this.getSvgTransform(), '" ', ">\n"],
                ...
                if (!b.Group) {
                    ...
                    b.Group = b.util.createClass(b.Object, b.Collection, {
                        ...
                        removeWithUpdate: function (a) {
                            return this._moveFlippedObject(a),
                        ...
                        render: function (a) {
                            if (this.visible) {
                                ...
                                for (var c = 0, d = this._objects.length; c < d; c++)
                                    this._renderObject(this._objects[c], a);
                                this.clipTo && a.restore(),
                                    a.restore()
                            }
                        },
                        ...
                        _renderObject: function (a, b) {
                            ...
                            a.visible && (a.hasRotatingPoint = !1,
                                a.render(b),
                        ...
                        _toggleFlipping: function (a) {
                            this.flipX && (a.toggle("flipX"),
                                a.set("left", -a.get("left")),
                                a.setAngle(-a.getAngle())),
                            this.flipY && (a.toggle("flipY"),
                                a.set("top", -a.get("top")),
                                a.setAngle(-a.getAngle()))
                        },
                        _restoreObjectState: function (a) {
                            return this._setObjectPosition(a),
                                a.setCoords(),
                        ...
                        _calcBounds: function (a) {
                            for (var d, b = [], c = [], e = 0, f = this._objects.length; e < f; ++e) {
                                d = this._objects[e],
                                    d.setCoords();
                                for (var g in d.oCoords)
                                    b.push(d.oCoords[g].x),
                                        c.push(d.oCoords[g].y)
                            }
            ...
            function (a) {
                ...
                return a.fabric || (a.fabric = {}),
                    a.fabric.Image ? void fabric.warn("fabric.Image is already defined.") : (fabric.Image = fabric.util.createClass(fabric.Object, {
                        type: "image",
                        crossOrigin: "",
                        initialize: function (a, b) {
                            b || (b = {}),
                                ...
                                this._initConfig(b),
                            b.filters && (this.filters = b.filters,
                                this.applyFilters())
                        },
                        getElement: function () {
                        ...
                        _stroke: function (a) {
                            a.save(),
                                this._setStrokeStyles(a),
                                a.beginPath(),
                                a.strokeRect(-this.width / 2, -this.height / 2, this.width, this.height),
                                a.closePath(),
                                a.restore()
                        },
                        _renderDashedStroke: function (a) {
                            ...
                            a.save(),
                                this._setStrokeStyles(a),
                                a.beginPath(),
                                fabric.util.drawDashedLine(a, b, c, b + d, c, this.strokeDashArray),
                                fabric.util.drawDashedLine(a, b + d, c, b + d, c + e, this.strokeDashArray),
                                fabric.util.drawDashedLine(a, b + d, c + e, b, c + e, this.strokeDashArray),
                                fabric.util.drawDashedLine(a, b, c + e, b, c, this.strokeDashArray),
                                a.closePath(),
                                a.restore()
                        },
                        toObject: function (a) {
                        ...
                        applyFilters: function (a) {
                            if (this._originalElement) {
                                ...
                                return c.width = b.width,
                                    ...
                                    d.width = b.width,
                                    d.height = b.height,
                                    fabric.isLikelyNode ? (d.src = c.toBuffer(undefined, fabric.Image.pngCompression),
                                        e._element = d,
                                    a && a()) : (d.onload = function () {
                                        e._element = d,
                                        a && a(),
                                            d.onload = c = b = null
                                    }
                        ...
                        _render: function (a, b) {
                            this._element && a.drawImage(this._element, b ? this.left : -this.width / 2, b ? this.top : -this.height / 2, this.width, this.height),
                                this._renderStroke(a)
                        },
            ...
            function (a) {
                ...
                b.Image.filters.Brightness = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        for (var b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                                 e = this.brightness, f = 0, g = d.length; f < g; f += 4)
                            d[f] += e,
                                d[f + 1] += e,
                                d[f + 2] += e;
            ...
            function (a) {
                ...
                b.Image.filters.Convolute = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        for (var b = this.matrix, c = a.getContext("2d"), d = c.getImageData(0, 0, a.width, a.height),
                                 e = Math.round(Math.sqrt(b.length)), f = Math.floor(e / 2), g = d.data, h = d.width,
                                 i = d.height, j = h, k = i, l = this._createImageData(j, k), m = l.data,
                                 n = this.opaque ? 1 : 0, o = 0; o < k; o++)
                            for (var p = 0; p < j; p++) {
                                for (var q = o, r = p, s = 4 * (o * j + p), t = 0, u = 0, v = 0, w = 0,
                                         x = 0; x < e; x++)
                                    for (var y = 0; y < e; y++) {
                                        var z = q + x - f
                                            , A = r + y - f;
            ...
            function (a) {
                ...
                b.Image.filters.GradientTransparency = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        for (var b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                                 e = this.threshold, f = d.length, g = 0, h = d.length; g < h; g += 4)
                            d[g + 3] = e + 255 * (f - g) / f;
                        b.putImageData(c, 0, 0)
                    },
                    toObject: function () {
            ...
            function (a) {
                ...
                b.Image.filters.Grayscale = b.util.createClass(b.Image.filters.BaseFilter, {
                    type: "Grayscale",
                    applyTo: function (a) {
                        for (var g, b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                                 e = c.width * c.height * 4, f = 0; f < e;)
                            g = (d[f] + d[f + 1] + d[f + 2]) / 3,
                                d[f] = g,
                                d[f + 1] = g,
                                d[f + 2] = g,
            ...
            function (a) {
                ...
                b.Image.filters.Invert = b.util.createClass(b.Image.filters.BaseFilter, {
                    type: "Invert",
                    applyTo: function (a) {
                        var f, b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                            e = d.length;
                        for (f = 0; f < e; f += 4)
                            d[f] = 255 - d[f],
                                d[f + 1] = 255 - d[f + 1],
                ...
                b.Image.filters.Mask = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        if (this.mask) {
                            ...
                            g.width = f.width,
                                g.height = f.height,
                                g.getContext("2d").drawImage(f, 0, 0, f.width, f.height);
                            var k = g.getContext("2d").getImageData(0, 0, f.width, f.height)
                                , l = k.data;
                            for (i = 0; i < j; i += 4)
                                e[i + 3] = l[i + h];
            ...
            function (a) {
                ...
                b.Image.filters.Noise = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        for (var f, b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                                 e = this.noise, g = 0, h = d.length; g < h; g += 4)
                            f = (.5 - Math.random()) * e,
                                d[g] += f,
                                d[g + 1] += f,
                                d[g + 2] += f;
                        ...
                        for (h = 0; h < e; h += this.blocksize)
                            for (i = 0; i < f; i += this.blocksize) {
                                g = 4 * h * f + 4 * i,
                                    ...
                                    l = d[g + 2],
                                    m = d[g + 3];
                                for (var n = h, o = h + this.blocksize; n < o; n++)
                                    for (var p = i, q = i + this.blocksize; p < q; p++)
                                        g = 4 * n * f + 4 * p,
                                            d[g] = j,
                                            d[g + 1] = k,
                                            d[g + 2] = l,
            ...
            function (a) {
                ...
                b.Image.filters.RemoveWhite = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        for (var i, j, k, b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height),
                                 d = c.data, e = this.threshold, f = this.distance, g = 255 - e, h = Math.abs, l = 0,
                                 m = d.length; l < m; l += 4)
                            i = d[l],
                                j = d[l + 1],
                                k = d[l + 2],
                            i > g && j > g && k > g && h(i - j) < f && h(i - k) < f && h(j - k) < f && (d[l + 3] = 1);
                        b.putImageData(c, 0, 0)
                    },
                    toObject: function () {
                        return c(this.callSuper("toObject"), {
            ...
            function (a) {
                ...
                b.Image.filters.Sepia = b.util.createClass(b.Image.filters.BaseFilter, {
                    type: "Sepia",
                    applyTo: function (a) {
                        var f, g, b = a.getContext("2d"), c = b.getImageData(0, 0, a.width, a.height), d = c.data,
                            e = d.length;
                        for (f = 0; f < e; f += 4)
                            g = .3 * d[f] + .59 * d[f + 1] + .11 * d[f + 2],
                                d[f] = g + 100,
                                d[f + 1] = g + 50,
                                d[f + 2] = g + 255;
                        b.putImageData(c, 0, 0)
                    ...
                    applyTo: function (a) {
                        ...
                        for (f = 0; f < e; f += 4)
                            g = d[f],
                                h = d[f + 1],
                                i = d[f + 2],
                                d[f] = (.393 * g + .769 * h + .189 * i) / 1.351,
                                d[f + 1] = (.349 * g + .686 * h + .168 * i) / 1.203,
                                d[f + 2] = (.272 * g + .534 * h + .131 * i) / 2.14;
                        b.putImageData(c, 0, 0)
                    }
                }),
            ...
            function (a) {
                ...
                b.Image.filters.Tint = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        var g, h, i, j, k, l, m, n, o, c = a.getContext("2d"),
                            d = c.getImageData(0, 0, a.width, a.height), e = d.data, f = e.length;
                        for (o = new b.Color(this.color).getSource(),
                                 h = o[0] * this.opacity,
                                 i = o[1] * this.opacity,
                                 j = o[2] * this.opacity,
                                 n = 1 - this.opacity,
            ...
            function (a) {
                ...
                b.Image.filters.Multiply = b.util.createClass(b.Image.filters.BaseFilter, {
                    ...
                    applyTo: function (a) {
                        var g, h, c = a.getContext("2d"), d = c.getImageData(0, 0, a.width, a.height), e = d.data,
                            f = e.length;
                        for (h = new b.Color(this.color).getSource(),
                                 g = 0; g < f; g += 4)
                            e[g] *= h[0] / 255,
                                e[g + 1] *= h[1] / 255,
                                e[g + 2] *= h[2] / 255;
            ...
            function (a) {
                ...
                b.Image.filters.Blend = b.util.createClass({
                    ...
                    initialize: function (a) {
                        a = a || {},
                            this.color = a.color || "#000",
                            this.image = a.image || !1,
                            this.mode = a.mode || "multiply",
                    ...
                    applyTo: function (a) {
                        ...
                        if (this.image) {
                            ...
                            n.width = this.image.width,
                                n.height = this.image.height;
                            var o = new b.StaticCanvas(n);
                            o.add(this.image);
                            var p = o.getContext("2d");
                            l = p.getImageData(0, 0, o.width, o.height).data
                        } else
                            l = new b.Color(this.color).getSource(),
                                f = l[0] * this.alpha,
                                g = l[1] * this.alpha,
                                h = l[2] * this.alpha;
                        for (var q = 0, r = e.length; q < r; q += 4)
                            switch (i = e[q],
                                j = e[q + 1],
                                k = e[q + 2],
                            m && (f = l[q] * this.alpha,
                                ...
                                case "screen":
                                    ...
                                    break;
                                case "add":
                                    e[q] = Math.min(255, i + f),
                                        e[q + 1] = Math.min(255, j + g),
                                        e[q + 2] = Math.min(255, k + h);
                                    break;
                                case "diff":
                                case "difference":
                                    e[q] = Math.abs(i - f),
            ...
            function (a) {
                ...
                g.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor", "useNative", "path"),
                    b.Text = b.util.createClass(b.Object, {
                        ...
                        _renderText: function (a, b) {
                            a.save(),
                                this._setShadow(a),
                                this._setupFillRule(a),
                                this._renderTextFill(a, b),
                                this._renderTextStroke(a, b),
                                this._restoreFillRule(a),
                                this._removeShadow(a),
                                a.restore()
                        },
                        _translateForTextAlign: function (a) {
                            "left" !== this.textAlign && "justify" !== this.textAlign && (a.save(),
                        ...
                        _renderTextLine: function (a, b, c, d, e, f) {
                            if (e -= this.fontSize / 4,
                                "justify" !== this.textAlign)
                                return void this._renderChars(a, b, c, d, e, f);
                            var g = b.measureText(c).width
                                , h = this.width;
                            if (h > g)
                                for (var i = c.split(/\s+/), j = b.measureText(c.replace(/\s+/g, "")).width, k = h - j,
                                         l = i.length - 1, m = k / l, n = 0, o = 0, p = i.length; o < p; o++)
                                    this._renderChars(a, b, i[o], d + n, e, f),
                        ...
                        _renderTextFill: function (a, b) {
                            if (this.fill || this._skipFillStrokeCheck) {
                                ...
                                for (var c = 0, d = 0, e = b.length; d < e; d++) {
                                    ...
                                    c += f,
                                        this._renderTextLine("fillText", a, b[d], this._getLeftOffset(), this._getTopOffset() + c, d)
                                }
                            }
                        },
                        _renderTextStroke: function (a, b) {
                            if (this.stroke && 0 !== this.strokeWidth || this._skipFillStrokeCheck) {
                                ...
                                for (var d = 0, e = b.length; d < e; d++) {
                                    ...
                                    c += g,
                                        this._renderTextLine("strokeText", a, b[d], this._getLeftOffset(), this._getTopOffset() + c, d)
                                }
                                a.closePath(),
                                    a.restore()
                            }
                        ...
                        _renderTextBoxBackground: function (a) {
                            this.backgroundColor && (a.save(),
                                a.fillStyle = this.backgroundColor,
                                a.fillRect(this._getLeftOffset(), this._getTopOffset(), this.width, this.height),
                                a.restore())
                        },
                        ...
                        _renderTextDecoration: function (a, b) {
                            function e(e) {
                                for (var f = 0, g = b.length; f < g; f++) {
                                    var h = d._getLineWidth(a, b[f])
                                        , i = d._getLineLeftOffset(h);
                                    a.fillRect(d._getLeftOffset() + i, ~~(e + f * d._getHeightOfLine(a, f, b) - c), h, 1)
                                }
                            }

                            if (this.textDecoration) {
                                var c = this._getTextHeight(a, b) / 2
                                    , d = this;
                                this.textDecoration.indexOf("underline") > -1 && e(this.fontSize * this.lineHeight),
                                this.textDecoration.indexOf("line-through") > -1 && e(this.fontSize * this.lineHeight - this.fontSize / 2),
                                this.textDecoration.indexOf("overline") > -1 && e(this.fontSize * this.lineHeight - this.fontSize)
                            }
                        },
                        ...
                        render: function (a, b) {
                            if (this.visible) {
                                a.save(),
                                    this._transform(a, b);
                                var c = this.transformMatrix
                                    , d = this.group && "path-group" === this.group.type;
                                d && a.translate(-this.group.width / 2, -this.group.height / 2),
                                c && a.transform(c[0], c[1], c[2], c[3], c[4], c[5]),
                                d && a.translate(this.left, this.top),
                                    this._render(a),
                                    a.restore()
                            }
                        },
                        ...
                        toSVG: function (a) {
                            var b = []
                                , c = this.text.split(this._reNewline)
                                , d = this._getSVGLeftTopOffsets(c)
                                , e = this._getSVGTextAndBg(d.lineTop, d.textLeft, c)
                                , f = this._getSVGShadows(d.lineTop, c);
                            return d.textTop += this._fontAscent ? this._fontAscent / 5 * this.lineHeight : 0,
                                this._wrapSVGTextAndBg(b, e, f, d),
                                a ? a(b.join("")) : b.join("")
                        },
                        ...
                        _getSVGShadows: function (a, c) {
                            ...
                            for (f = 0,
                                ...
                                if ("" !== c[f]) {
                                    ...
                                    d.push('<tspan x="', e(i + h + this.shadow.offsetX, 2), 0 === f || this.useNative ? '" y' : '" dy', '="', e(this.useNative ? a * f - this.height / 2 + this.shadow.offsetY : a + (0 === f ? this.shadow.offsetY : 0), 2), '" ', this._getFillAttributes(this.shadow.color), ">", b.util.string.escapeXml(c[f]), "</tspan>"),
                                        h = 1
                                } else
                                    h++;
                            return d
                        ...
                        _getSVGTextAndBg: function (a, b, c) {
                            ...
                            for (var g = 0, h = c.length; g < h; g++)
                                "" !== c[g] ? (this._setSVGTextLineText(c[g], g, d, a, f, e),
                                    f = 1) : f++,
                                this.textBackgroundColor && this._boundaries && this._setSVGTextLineBg(e, g, b, a);
                            return {
                                textSpans: d,
                                textBgRects: e
                            }
                        ...
                        _set: function (a, b) {
                            "fontFamily" === a && this.path && (this.path = this.path.replace(/(.*?)([^\/]*)(\.font\.js)/, "$1" + b + "$3")),
                    ...
                    b.Text.fromElement = function (a, c) {
                        ...
                        var e = new b.Text(a.textContent, c)
                            , f = 0;
                        return "left" === e.originX && (f = e.getWidth() / 2),
                        "right" === e.originX && (f = -e.getWidth() / 2),
                            e.set({
                                left: e.getLeft() + f,
